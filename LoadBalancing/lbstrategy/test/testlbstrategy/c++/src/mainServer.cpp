...
int main( int argc, char* argv[] )
{
	...
	strategyList.add_multicast();
        ...
        Cdmw::Pingable_impl * pingable_interface
            = new Cdmw::Pingable_impl(host_name.c_str());
        CdmwLBStrategy::Pingable_var pingable_interface_ref
            =  pingable_interface->_this();

        // export the object reference to a file
        CORBA::String_var ref_string = orb->object_to_string(pingable_interface_ref.in());
