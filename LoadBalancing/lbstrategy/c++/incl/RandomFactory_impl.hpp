...
#ifndef INCL_CDMW_LB_RANDOM_FACTORY_IMPL_H
#define INCL_CDMW_LB_RANDOM_FACTORY_IMPL_H
...
namespace LB
{
    ...
    class RandomFactory_impl : public CdmwLB::StrategyFactory
    {
    public:
        
        // Constructor.
        RandomFactory_impl(Cdmw::LB::IOGRFactory* iogr_factory);
...
#endif //INCL_CDMW_LB_RANDOM_FACTORY_IMPL_H
