...
#include "testtxdatastore/TestHello.skel.hpp"

#include <string>

namespace Cdmw
{
    typedef Cdmw::FT::TXDataStore<int, std::string> MyTestDataStore;
    ...
    class HelloInterface_impl :
        public virtual POA_CdmwReplicationManager::HelloInterface,
    ...
    private:
        ...
        Cdmw::FT::TXManager* m_manager;

        MyTestDataStore* dataStoreObj1;
    
        MyTestDataStore* dataStoreObj2;
