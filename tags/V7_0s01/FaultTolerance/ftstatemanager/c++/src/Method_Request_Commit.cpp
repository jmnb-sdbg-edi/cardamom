...
#include "ftstatemanager/Method_Request_Commit.hpp"

namespace Cdmw {
namespace FT {
namespace Scheduler {

Method_Request_Commit::Method_Request_Commit
...
Method_Request_Commit::~Method_Request_Commit (void) throw()
{
}


void Method_Request_Commit::run () throw()
{
    try
    {
        CdmwFT::Transaction::TransactionSender_var sender;
        m_cohort->commit(m_id, sender.out());
