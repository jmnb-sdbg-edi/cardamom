...
#include <fstream>
#include <ccm_ft_timers/GroupCreatorProcessBehaviour.hpp>
#include <FaultTolerance/ftcommon/FactoryInfos.hpp>


static const char* APPLICATION_NAME = "FTApplication";
    ...
    throw( CORBA::SystemException )
{
    ...
    ::FT::ObjectGroup_var serverWithEventsGroup = 
        create_object_group("IDL:thalesgroup.com/Cdmw_CcmFtTest/ServerWithEvents:1.0", 3);
