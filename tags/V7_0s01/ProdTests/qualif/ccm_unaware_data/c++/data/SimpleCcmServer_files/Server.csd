...
<softpkg name="Server" version="1,0,0,0">
    <pkgtype>CORBA Component</pkgtype>

    <idl id="IDL:acme.com/SimpleCcmServer/Server:1.0" >
        <fileinarchive name="SimpleCcmServer.idl"/>
    </idl>
    ...
    <implementation id="DCE:700dc518-0110-11ce-ac8f-0800090b5d3e">
        ...
        <code type="DLL">
            <fileinarchive name="libcdmwSimpleCcmServer.so"/>
            <entrypoint>create_CCM_ServerHome</entrypoint>
        </code>
