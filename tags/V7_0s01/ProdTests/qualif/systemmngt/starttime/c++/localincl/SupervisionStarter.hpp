...
#ifndef INCL_CDMW_QUALIF_SUPERVISION_STARTER_HPP 
#define INCL_CDMW_QUALIF_SUPERVISION_STARTER_HPP
...
class SupervisionStarter : public ProcessStarter
{
    private:
        static const std::string SUPERVISION_EXE;
        static const std::string SUPERVISION_CORBALOC;
    
    
    public:
        
        SupervisionStarter(const std::string& args,
                           CORBA::ORB_ptr orb);
