...
#ifndef INCL_TEST_CRASH_PROCESS_MEASURE_THREAD_HPP
#define INCL_TEST_CRASH_PROCESS_MEASURE_THREAD_HPP
...
class TestCrashProcessMeasureThread : public Cdmw::OsSupport::Thread
{

public:
        
    TestCrashProcessMeasureThread(
        CORBA::ORB_ptr orb,
    ...
    virtual ~TestCrashProcessMeasureThread()
        throw()
    {
    }
...
protected:
    ...
    void run() throw()
    {
        ...
        Cdmw:: TestCrashProcessMeasure test(m_orb.in(),
                                            m_poa.in(),
                                            m_name,
                                            m_nbobserver,
                                            m_nbtest,
...
#endif //INCL_TEST_CRASH_PROCESS_MEASURE_THREAD_HPP
