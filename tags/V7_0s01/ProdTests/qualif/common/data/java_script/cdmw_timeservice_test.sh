...
__TOOLS_CLASSPATH__=$__ORB_CLASSPATH__:@config.XercesJAVA.classpath@:@config.OpenORB.classpath@
...
exec java -Xbootclasspath/p:$__CLASSPATH__ cdmw.timeservice.test.MainTest $*
