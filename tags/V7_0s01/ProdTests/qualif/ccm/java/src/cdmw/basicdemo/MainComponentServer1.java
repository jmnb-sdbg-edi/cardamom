...
public class MainComponentServer1 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            CdmwInterface.cdmwInit(
                orb, args, null, "cdmw.generated.CdmwInterface1");
            ...
            //
            // Create LocalDisplay object
            //
            LocalDisplayImpl localDisplay_i = new LocalDisplayImpl();
            com.acme.BasicDemo.Display localDisplay = localDisplay_i._this(orb);
            cdmw.orbsupport.ORBSupport.bindObjectToCorbaloc(orb, "LocalDisplay", localDisplay);
        ...
        if (orb != null) {
            try {
                CdmwInterface.cdmwCleanup(
                    orb, "cdmw.generated.CdmwInterface1");
                orb.destroy();
            } catch(Exception ex) {
                System.err.println(ex.getMessage());
            }
