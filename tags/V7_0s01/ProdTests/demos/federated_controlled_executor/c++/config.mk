...
#MAC COMMENT: macro LDFLAGS_linux can be empty
#LDFLAGS_linux=-lpthread -ldl
LDFLAGS_linux=
IDLFLAGS_linux=
#MAC COMMENT: macro LIBS_linux cannot be empty
#LIBS_linux=
LIBS_linux=-lpthread -ldl -luuid
# -------------------------------------------------------------------------------
...
#BEGIN CDMW FLAGS
CPPFLAGS_CDMW=-I$(CDMW_HOME)/include/c++ -I$(CDMW_HOME)/include/c++/cdmwidl -I$(XERCES_INC_PATH) -D_REENTRANT -DCDMW_ASSERT_NO_THROW
CXXFLAGS_CDMW=
LDFLAGS_CDMW=-L$(CDMW_HOME)/lib/c++ -L$(XERCES_LIB_PATH)
IDLFLAGS_CDMW=-I$(CDMW_HOME)/idl

#MAC COMMENT: macro LIBS_CDMW could change
...
LIBS_CDMW=-lcdmwcommon -lcdmworbsupport -lcdmwossupport -lcdmwosthreads -lcdmwcommonsvcsfederation -lcdmwclockservice -lcdmwcommonidl -lcdmwlogging
#END CDMW FLAGS
...
#MAC COMMENT: macro LDFLAGS would be better written in the following way
#LDFLAGS=$(LDFLAGS_$(HOST_SUFFIX)) $(LDFLAGS_ORB) $(LDFLAGS_CDMW)
LDFLAGS=$(LDFLAGS_CDMW) $(LDFLAGS_ORB) $(LDFLAGS_$(HOST_SUFFIX))
IDLFLAGS=$(IDLFLAGS_$(HOST_SUFFIX)) $(IDLFLAGS_CDMW) $(IDLFLAGS_ORB)
#MAC COMMENT: macro LIBS would be better written in the following way
#LIBS=$(LIBS_$(HOST_SUFFIX)) $(LIBS_ORB) $(LIBS_CDMW)
LIBS=$(LIBS_CDMW) $(LIBS_ORB) $(LIBS_$(HOST_SUFFIX))
