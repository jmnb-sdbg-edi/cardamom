...
gr1<-"MarshCRd01HObS.png"		#NomeFile grafico Observation (*.png)
gr2<-"MarshCRd01HMean.png"		#NomeFile grafico Mean (*.png)
gr3<-"MarshCRd01HStd.png"		#NomeFile grafico StdDev (*.png)
gr4<-"MarshCRd01HBox.png"		#NomeFile grafico BoxPlot (*.png)
grRO<-"MarshCRd01HRAMObs.png"		#NomeFile grafico RAMObs (*.png)
grR<-"MarshCRd01HRAM.png"		#NomeFile grafico RAM (*.png)
grCO<-"MarshCRd01HCPUObs.png"		#NomeFile grafico CPUObs (*.png)
grC<-"MarshCRd01HCPU.png"		#NomeFile grafico CPU (*.png)
som<-"MarshallingCRd01H.htm"		#NomeFile Sommario (*.htm)
