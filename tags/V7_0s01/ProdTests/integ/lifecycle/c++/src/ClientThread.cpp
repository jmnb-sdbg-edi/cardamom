...
#include "lifecycle/TestEntityStrategyRestart.hpp"
#include "lifecycle/TestUnManagedEntityStrategy.hpp"
#include "lifecycle/TestUnManagedEntityStrategyRestart.hpp"
#include "lifecycle/TestSessionStrategy.hpp"
...
//----------------------------------------------------------------------------
const CORBA::ULong ClientThread::nb_commands = 12;
