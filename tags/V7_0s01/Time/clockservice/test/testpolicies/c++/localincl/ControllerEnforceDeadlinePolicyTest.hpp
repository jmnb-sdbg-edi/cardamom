...
#ifndef CONTROLLERENFORCEDEADLINEPOLICYTEST_HPP
#define CONTROLLERENFORCEDEADLINEPOLICYTEST_HPP
/**
 * 
 ...
 */
class ControllerEnforceDeadlinePolicyTest 
:   public CppUnit::TestFixture
{
    CPPUNIT_TEST_SUITE( ControllerEnforceDeadlinePolicyTest );
...
public:
    ControllerEnforceDeadlinePolicyTest();
    void setUp();
    void tearDown() ;
    void check_policy();
    void on_set ();
...
#endif // CONTROLLERENFORCEDEADLINEPOLICYTEST_HPP
