...
#ifndef CARDAMOM_CLOCK_CONTROLLER_ENFORCE_INTERVAL_POLICY_HPP
#define CARDAMOM_CLOCK_CONTROLLER_ENFORCE_INTERVAL_POLICY_HPP
...
class  ControllerEnforceIntervalPolicy 
	:  public virtual Cdmw::clock::policy::ControllerUpdate_impl
{
public:
		  ControllerEnforceIntervalPolicy ();
  
		  virtual ~ControllerEnforceIntervalPolicy ();
...
#endif /*CARDAMOM_CLOCK_CONTROLLER_ENFORCE_INTERVAL_POLICY_HPP*/
