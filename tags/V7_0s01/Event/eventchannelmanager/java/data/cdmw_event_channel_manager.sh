...
__CLASSPATH__=$__CLASSPATH__:@config.XercesJAVA.classpath@
...
@CDMW_LIFECYCLE_LIB_JAR_PATH@/lib@config.lowercase.product.name@lifecycle.jar:\
...
@CDMW_EVENT_LIB_JAR_PATH@/lib@config.lowercase.product.name@eventidl.jar:\
@CDMW_EVENT_LIB_JAR_PATH@/lib@config.lowercase.product.name@eventinterface.jar:\
@CDMW_EVENT_LIB_JAR_PATH@/lib@config.lowercase.product.name@eventsupport.jar:\
@CDMW_EVENT_BIN_JAR_PATH@/eventchannelmanager.jar:\
...
exec java -Xbootclasspath/p:$__CLASSPATH__  cdmw.eventadmin.EventChannelManager $*
