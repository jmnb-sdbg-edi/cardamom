...
#ifndef INCL_PLATFORMMNGT_PROXY_APPLICATIONS_ITERATOR_IMPL_HPP
#define INCL_PLATFORMMNGT_PROXY_APPLICATIONS_ITERATOR_IMPL_HPP
...
public:
     ...
     *
     */
     ApplicationsIterator_impl (CORBA::ORB_ptr orb,
...
public:           
     ...
     */
    virtual 
    ~ApplicationsIterator_impl() throw();
    ...
    * operation
    */
    virtual CORBA::Boolean next_one(CdmwPlatformMngt::Application_out entity)
        throw(CORBA::SystemException);
...
#endif // INCL_PLATFORMMNGT_PROXY_APPLICATIONS_ITERATOR_IMPL_HPP
