...
CORBA::ORB_var    Cdmw::TestPerfDaemon::m_orb;
PortableServer::POA_var Cdmw::TestPerfDaemon::m_poa;
std::string       Cdmw::TestPerfDaemon::m_nbtest;
std::string       Cdmw::TestPerfDaemon::m_supervision;
std::string       Cdmw::TestPerfDaemon::m_limittime;
std::string       Cdmw::TestPerfDaemon::m_percentcase;
...
protected:
    ...
    Cdmw::TestPerfDaemon::m_orb = CORBA::ORB::_duplicate(m_orb.in());
    Cdmw::TestPerfDaemon::m_poa = PortableServer::POA::_duplicate(m_poa.in());
    Cdmw::TestPerfDaemon::m_nbtest = m_nbtest;
    Cdmw::TestPerfDaemon::m_supervision = m_supervision;
    Cdmw::TestPerfDaemon::m_limittime = m_limittime;
    Cdmw::TestPerfDaemon::m_percentcase = m_percentcase; 
