...
#ifndef INCL_TEST_EXCEPTION_HPP
#define INCL_TEST_EXCEPTION_HPP
...
private:
    ...
    void operator=(const TestException&);

public:
    static CORBA::ORB_var m_orb;
    static std::string m_daemon;
    static std::string m_system;
