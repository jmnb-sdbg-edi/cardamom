...
#ifndef INCL_PLATFORMMNGT_ORBACUS_TIME_OUT_POLICY_SERVICE_HPP
#define INCL_PLATFORMMNGT_ORBACUS_TIME_OUT_POLICY_SERVICE_HPP
 ...
 *<p> 
 */        
class OrbacusTimeOutPolicyService : public TimeOutPolicyService 
{
private:
...
public:
     ...
     *<p> Constructor
     *
     *@return An Orbacus TimeOutPolicyService.
     */
    OrbacusTimeOutPolicyService();
...
public:
     ...
     */
    CORBA::Object_ptr SetTimeoutPolicy(CORBA::ORB_ptr orb,
...
#endif //INCL_PLATFORMMNGT_ORBACUS_TIME_OUT_POLICY_SERVICE_HPP
