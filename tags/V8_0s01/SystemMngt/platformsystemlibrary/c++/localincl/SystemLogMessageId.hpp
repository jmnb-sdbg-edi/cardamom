...
/**
* "Supervision Process Name not specified"
*/
const long MSG_ID_SUPERVISION_PROCESS_NAME_NOT_SPECIFIED = MSG_ID_SYSTEM_START + 46;

/**
* "PullMonitoring Registration Callback IOR not specified"
*/
const long MSG_ID_SUPERVISION_CALLBACK_IOR_NOT_SPECIFIED = MSG_ID_SYSTEM_START + 47;

/**
* "Add Entity \"%s\" for system \"%s\""
*/
const long MSG_ID_ADD_SYSTEM_ENTITY = MSG_ID_SYSTEM_START + 48;

/**
* "Remove Entity \"%s\" for system \"%s\""
*/
const long MSG_ID_REMOVE_SYSTEM_ENTITY = MSG_ID_SYSTEM_START + 49;

/**
* "Add Entity \"%s\" for host \"%s\""
*/
const long MSG_ID_ADD_HOST_ENTITY = MSG_ID_SYSTEM_START + 50;

/**
* "Remove Entity \"%s\" for host \"%s\""
*/
const long MSG_ID_REMOVE_HOST_ENTITY = MSG_ID_SYSTEM_START + 51;
...
*/
const long MSG_ID_SYSTEM_END = MSG_ID_SYSTEM_START + 52;
