                                 ...
                                 virtual public PortableServer::RefCountServantBase
{
    ...
    protected:
        ...
        /**
        * Define the ServiceProviderID element
        */
        typedef Container<CdmwPlatformMngtService::ServiceProviderID>::Element ServiceProviderIDElement;
        
        /**
        * Define the ServiceProviderIDNameList
        */
        typedef Container<CdmwPlatformMngtService::ServiceProviderID>::ElementNameList ServiceProviderIDNameList;
    
        /**
        * Define the ServiceProviderIDList
        */
        typedef Container<CdmwPlatformMngtService::ServiceProviderID>::ElementList ServiceProviderIDList;
