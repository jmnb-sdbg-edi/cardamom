...
# @brief script to start the testuserattributes
...
echo $PID_DAEMON
echo "Wait 15 seconds to be sure that platform daemon is up ..."
sleep 15 
...
echo "Starting cdmw_testattributes ..."

#xterm -font 10x20 -e "gdb 
#xterm -font 10x20 -e "read -s -n 1 -p 'Hit a Key When You receive the message to kill the Daemon!!!' ;echo $PID_DAEMON; cdmw_platform_kill_all_pids.sh /tmp/CdmwDaemon_21869"&
#  kill -9  $PID_DAEMON ; sleep 10"&


./cdmw_testvalidpersistenceuserdefinedattributes
