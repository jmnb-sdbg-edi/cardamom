...
<!--
   ...
   @param none
-->
<xsl:template name="unmanaged_entity_factory_cpp">
   <!--
      ...
      <xsl:if test="$_index &lt;= count($nodes)">
         ...
         <xsl:document method="text" href="{$filename}">
            ...
            <!--
               Insert the content.
            -->
            <xsl:call-template name="unmanaged_entity_factory_cpp.content">
         ...
         -->
         <xsl:call-template name="unmanaged_entity_factory_cpp">
            <xsl:with-param name="_index" select="$_index + 1"/>
         </xsl:call-template>
      </xsl:if>
   </xsl:if>
</xsl:template> <!-- end of template unmanaged_entity_factory_cpp -->
...
-->
<xsl:template name="unmanaged_entity_factory_cpp.content">
   ...
   <xsl:call-template name="findAllFactoryOperations">
      ...
      <xsl:with-param name="_template" select="'unmanaged_entity_factory_cpp.content.1'"/>
...
</xsl:template> <!-- end of template unmanaged_entity_factory_cpp.content -->


<!--
-->
<xsl:template name="unmanaged_entity_factory_cpp.content.1">
