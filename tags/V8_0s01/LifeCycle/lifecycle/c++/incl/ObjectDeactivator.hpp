...
#ifndef INCL_LIFECYCLE_OBJECT_DEACTIVATOR_HPP
#define INCL_LIFECYCLE_OBJECT_DEACTIVATOR_HPP
...
namespace Cdmw
{
    ...
    namespace LifeCycle
    {
        ...
        /**
        *Purpose:
        *<p>    Base class for Object Dectivators. An Object Deactivator is to be used
        ...
        */
        ...
        class ObjectDeactivator
        {
            ...
            public:
                 ...
                 */
                explicit ObjectDeactivator(CORBA::ORB_ptr orb)
                 ...
                 *@exception CORBA::SystemException Any CORBA system exception
                 */
                inline PortableServer::POA_ptr get_POA() const
                throw(PortableServer::Current::NoContext,
                      CORBA::SystemException)
                {
                    return m_current->get_POA();
                }
                 ...
                 *@exception CORBA::SystemException Any CORBA system exception
                 */
                inline PortableServer::ObjectId* get_object_id() const
                throw(PortableServer::Current::NoContext,
                      CORBA::SystemException)
                {
                    return m_current->get_object_id();
                }
            ...
            protected:
                ...
                /**
                 * Purpose:
                 * <p>This method does the actual deactivation of the calling object. It is a pure virtual
                 * method to be defined by derived classes.
                 * 
            ...
            private:
                ...
                ObjectDeactivator(const ObjectDeactivator& rhs)
                throw();
                ObjectDeactivator&
                operator=(const ObjectDeactivator& rhs)
                throw();
                /**
...
; // End namespace Cdmw
#endif // INCL_LIFECYCLE_OBJECT_DEACTIVATOR_HPP
