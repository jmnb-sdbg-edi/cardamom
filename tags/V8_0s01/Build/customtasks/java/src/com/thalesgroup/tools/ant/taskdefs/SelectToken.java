...
public class SelectToken extends Task {
    ...
    public void setDelimiter(String delimiter) {
        if ((delimiter != null) && (delimiter != "")) {
            // We don't use regular expressions in delimiter,
            // thus, quote all string using \Q and \E
            // (see Java API for java.util.regex.Pattern class)
            m_delimiter = "\\Q" + delimiter + "\\E";
        } else {
        ...
        if (tokens.length >= 0) {
            ...
            if (!m_lastToken) {
                try {
                    ...
                    // ignore exception, value will be ""
                }
            } else {
