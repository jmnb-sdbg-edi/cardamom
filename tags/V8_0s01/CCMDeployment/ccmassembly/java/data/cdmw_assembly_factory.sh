...
@CDMW_CCMCONTAINER_LIB_JAR_PATH@/lib@config.lowercase.product.name@ccmconfigurator.jar:\
@CDMW_CCMDEPLOYMENT_LIB_JAR_PATH@/lib@config.lowercase.product.name@ccmassembly.jar:\

if [ -e @CDMW_FAULTTOLERANCE_LIB_JAR_PATH@/lib@config.lowercase.product.name@faulttoleranceidl.jar ]; then
    __CLASSPATH__=$__CLASSPATH__:@CDMW_FAULTTOLERANCE_LIB_JAR_PATH@/lib@config.lowercase.product.name@faulttoleranceidl.jar
fi

if [ -e @CDMW_LOADBALANCING_LIB_JAR_PATH@/lib@config.lowercase.product.name@loadbalancingidl.jar ]; then
    __CLASSPATH__=$__CLASSPATH__:@CDMW_LOADBALANCING_LIB_JAR_PATH@/lib@config.lowercase.product.name@loadbalancingidl.jar
fi
...
exec java -Xbootclasspath/p:$__CLASSPATH__ cdmw.ccm.assembly.AssemblyFactory $*
