...
namespace Cdmw
{
    ...
    namespace OrbSupport
    {
        ...
        */
        ...
        TestOrbSupportServer_impl::TestOrbSupportServer_impl(CORBA::ORB_ptr orb, const std::string& corbaloc_name)
        throw()
            : m_nbThreads(0), m_orb(CORBA::ORB::_duplicate(orb)), m_corbaloc_name(corbaloc_name)
        {
        }
        ...
        //
        void
        TestOrbSupportServer_impl::remove_binding()
        throw( CORBA::SystemException )
        {
            OrbSupport::remove_corbaloc_binding (m_orb.in(), m_corbaloc_name.c_str());
        }
