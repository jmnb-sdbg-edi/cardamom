...
#include <idllib/CdmwFTIOGRFactory.stub.hpp>
...
public:
    ...
    static ::CdmwFT::Location::PrimaryBackupAdmin_ptr
    get_location_manager_ref_from_file(CORBA::ORB_ptr orb, std::string host_name)
        throw (CORBA::SystemException);

    static void
    location_manager_update_group_view
                         (CORBA::ORB_ptr orb, 
                          ::FT::ObjectGroup_ptr object_group,
                          CdmwFT::ReplicationManager_ptr replication_manager,
                          bool more = false)
