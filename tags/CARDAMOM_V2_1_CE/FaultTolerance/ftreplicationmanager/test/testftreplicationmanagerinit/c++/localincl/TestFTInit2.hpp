...
#ifndef INCL_TEST_FT_INIT_2_HPP
#define INCL_TEST_FT_INIT_2_HPP
...
class TestFTInit2 : virtual public Cdmw::TestUtils::Testable
{
public:
    // constructor
    TestFTInit2(CORBA::ORB_ptr                  orb,
...
private:
    TestFTInit2();
    TestFTInit2(const TestFTInit2&);
    void operator=(const TestFTInit2&);

    CORBA::ORB_var                  m_orb;
    PortableServer::POA_var         m_rootPOA;
    CdmwFT::FaultManagement::FaultDetector_var m_fd_group;
    CdmwFT::Test::HelloInterface_var m_h_group;    
    CdmwFT::ReplicationManager_var m_replication_manager;

    ::CdmwFT::ObjectGroupData m_object_group_data;
    // IOGR Factory
