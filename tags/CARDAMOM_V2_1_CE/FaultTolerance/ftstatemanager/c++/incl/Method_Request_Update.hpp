...
#ifndef _CDMW_FT_METHOD_REQUEST_UPDATE_HPP_
#define _CDMW_FT_METHOD_REQUEST_UPDATE_HPP_
...
/**
 * This class used to update a data on datastores during state transfer
 */
class Method_Request_Update : public Cdmw::OsSupport::Runnable
{
public:
    ...
    Method_Request_Update (Cdmw::FT::TransactionEngineCoordinatorBase<OID,DATA> * coordinator,
                           _Oid_in_type oid,
                           _Data_in_type data,
                           ACE_Future<TransactionResult> & future);

    virtual ~Method_Request_Update (void) throw();
...
//
template <class OID, class DATA>
Method_Request_Update<OID,DATA>::Method_Request_Update
...
template <class OID, class DATA>
Method_Request_Update<OID,DATA>::~Method_Request_Update (void) throw()
{
}


template <class OID, class DATA>
void Method_Request_Update<OID,DATA>::run () throw()
{ 
    try {
        m_coordinator->update_i(m_oid, m_data, m_future);
    } catch (...) {
        // ignore
    }
}
...
#endif // _CDMW_FT_METHOD_REQUEST_UPDATE_HPP_
