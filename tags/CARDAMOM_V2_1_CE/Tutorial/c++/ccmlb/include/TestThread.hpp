...
#ifndef ___CCM_LB_TEST_THREAD_HPP__
#define ___CCM_LB_TEST_THREAD_HPP__
...
public:
  TestThread();
    ...
    run() throw();
    void
    set_context(::CcmLbTest::CCM_Client_Context_ptr ctx)
      throw(CORBA::SystemException);

private:
    TestThread(const TestThread&);
    TestThread& operator = (const TestThread&);
    ::CcmLbTest::CCM_Client_Context_var m_ctx;
...
#endif // ___CCM_LB_TEST_THREAD_HPP__
