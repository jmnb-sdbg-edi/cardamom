 ...
 * ========================================================================= */
#ifndef INCL_CDMW_USER_DEFINED_STRATEGY_IMPL_H
#define INCL_CDMW_USER_DEFINED_STRATEGY_IMPL_H

/**
 * @brief UserDefined Strategy Implementation
 *
...
namespace Cdmw
{
    ...
    class UserDefinedStrategy_impl : public CdmwLB::Strategy
    {
    public:

        // Constructor.
        UserDefinedStrategy_impl();

        UserDefinedStrategy_impl(PortableGroup::ObjectGroup_ptr og,
