...
#ifndef INCL_LIFECYCLE_CLEANUP_NOTIFIER_HPP
#define INCL_LIFECYCLE_CLEANUP_NOTIFIER_HPP
...
namespace Cdmw
{
    ...
    */
    ...
    namespace LifeCycle
    {
        ...
        /**
        *Purpose:
        *<p>    This class provides a default implementation for a Cleanup
        ...
        class CleanupNotifier
        {
            ...
            public:
                ...
                */
                ...
                /**
                * Purpose:
                * <p>The purpose of this operation is to unregister the Object of the
                * specified object Id.
                *
            ...
            private:
                ...
                CleanupNotifier(const CleanupNotifier& rhs)
                throw();
                CleanupNotifier&
                operator=(const CleanupNotifier& rhs)
                throw();
        }

        ; // End class CleanupNotifier
...
; // End namespace Cdmw
#endif // INCL_LIFECYCLE_CLEANUP_NOTIFIER_HPP
