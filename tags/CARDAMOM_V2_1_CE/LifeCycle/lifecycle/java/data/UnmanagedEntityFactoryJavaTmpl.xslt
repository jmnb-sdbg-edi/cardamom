...
<!--
   ...
   @param none
-->
<xsl:template name="unmanaged_entity_factory_java">
   <!--
   ...
   -->
   <xsl:variable name="nodes" select="$lifecycleFrameworkNodes[factory-impl/@category = 'UNMANAGED_ENTITY']"/>
      ...
      <xsl:if test="$_index &lt;= count($nodes)">
         ...
         <xsl:variable name="filename">
            <xsl:call-template name="buildOutputFilename">
               ...
               <xsl:with-param name="_defaultFilename" select="'UnMngEntityResourceFactoryImpl'"/>
         ...
         <xsl:document method="text" href="{$filename}">
            ...
            <!--
               Insert the content.
            -->
            <xsl:call-template name="unmanaged_entity_factory_java.content">
         ...
         <xsl:document method="text" href="{$allocatorFilename}">
            ...
            <!--
               Insert the content.
            -->
            <xsl:call-template name="unmanaged_entity_factory_allocator_java.content">
         ...
         -->
         <xsl:call-template name="unmanaged_entity_factory_java">
            <xsl:with-param name="_index" select="$_index + 1"/>
         </xsl:call-template>
      </xsl:if>
   </xsl:if>
</xsl:template> <!-- end of template unmanaged_entity_factory_java -->
...
<!--
   ...
   @param _factoryImplClassname                          The factory classname.
   @param _scopedFactoryImplClassname                    The scoped factory classname.
   @param _isMultithread                                 Multithread flag.
-->
<xsl:template name="unmanaged_entity_factory_java.content">
...
public class <xsl:value-of select="$javaFactoryImplClassname"/>
   ...
   <xsl:call-template name="findAllJavaFactoryOperations">
        ...
        <xsl:with-param name="_template" select="'unmanaged_entity_factory_java.content.1'"/>
...
</xsl:template> <!-- end of template unmanaged_entity_factory_java.content -->
...
-->
<xsl:template name="unmanaged_entity_factory_allocator_java.content">
...
</xsl:template> <!-- end of template unmanaged_entity_factory_allocator_java.content -->



<xsl:template name="unmanaged_entity_factory_java.content.1">
