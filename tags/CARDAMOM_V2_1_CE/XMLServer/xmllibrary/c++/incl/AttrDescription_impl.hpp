...
#ifndef INCL_ATTRDESCRIPTION_IMPL_HPP
#define INCL_ATTRDESCRIPTION_IMPL_HPP
...
namespace Cdmw
{
    ...
    */
    ...
    namespace XMLUtils
    {
        ...
        class AttrDescription_impl : public virtual OBV_CdmwXML::AttrDescription,
                    public virtual CORBA::DefaultValueRefCountBase
        {

            protected:

                AttrDescription_impl();
                AttrDescription_impl(CdmwXML::NodeType type,
                                     CdmwXML::Node_ptr reference,
                                     const CdmwXML::DOMString& name,
                                     const CdmwXML::DOMString& value);

                friend class AttrDescriptionFactory_impl;
            ...
            public:
                ...
                //
                virtual CdmwXML::DOMString* name();

                //
                // IDL:thalesgroup.com/CdmwXML/AttrDescription/value:1.0
                //
                virtual CdmwXML::DOMString* value();
                virtual void value(const CdmwXML::DOMString& newVal);
