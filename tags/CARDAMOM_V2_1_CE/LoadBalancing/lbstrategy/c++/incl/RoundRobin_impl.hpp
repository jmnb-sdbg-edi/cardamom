...
#ifndef INCL_CDMW_LB_ROUND_ROBIN_IMPL_H
#define INCL_CDMW_LB_ROUND_ROBIN_IMPL_H

/**
 * @brief Round Robin Strategy Implementation
 *
 * @author Raffaella Panella <rpanella@amjsv.it>
 */
#define LB_TIME_REFRESH 5
...
namespace LB
{
    ...
    class RoundRobin_impl : public CdmwLB::Strategy
    {
    public:
        /// Constructor.
       RoundRobin_impl(PortableGroup::ObjectGroup_ptr og,
        ...
        /**
         * Return the next member to invoke, according to the Round Robin Strategy
         *
         * @param ClientRequestInfo the request to invoke
         */
        
        virtual CORBA::Object_ptr next_member (PortableInterceptor::ClientRequestInfo_ptr)
...
#endif //INCL_CDMW_LB_ROUND_ROBIN_IMPL_H
