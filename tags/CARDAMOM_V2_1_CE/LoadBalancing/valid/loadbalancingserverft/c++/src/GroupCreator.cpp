...
#include "loadbalancingserverft/MyGroupCreatorProcessBehaviour.hpp"
...
int main( int argc, char* argv[] )
{
    ...
    try
    {
        ...
        std::auto_ptr<MyGroupCreatorProcessBehaviour>
            pProcessBehaviour(new MyGroupCreatorProcessBehaviour(orb.in(),
								 point_to_point,
								 host_name1,
								 host_name2,
								 host_name3));
