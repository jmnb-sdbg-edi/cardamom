...
CcmLbTest::CCM_Client_impl::do_tests()
{
    ...
    TEST_INFO("Test the crash of an application...");
    TEST_INFO("kill the application CcmLbApplication1");
    std::cout<<"Press any key and Enter"<<std::endl;
    std::cin >> dummy;
    ...
    TEST_INFO("Test the crash of an host...");
    TEST_INFO("kill the HOST3");
    std::cout<<"Press any key and Enter"<<std::endl;
    std::cin >> dummy;
    ...
    TEST_INFO("Test the LoadBalancing Service with one replica alive in the component group...");
    TEST_INFO("kill the ServerProcess21");
    std::cout<<"Press any key and Enter"<<std::endl;
    std::cin >> dummy;
	...
	CORBA::String_var process_name =
            CORBA::string_dup(test_connections());
	TEST_INFO("REQUEST " << i << "...check the RoundRobin policy...there is only ServerProcess22 alive") ;
	TEST_INFO("the process called is ==> " << process_name.in());
    ...
    TEST_INFO("Test the crash of LBGroupManager...");
    TEST_INFO("kill the LBGroupManager");
    std::cout<<"Press any key and Enter"<<std::endl;
    std::cin >> dummy;
...
char*
CcmLbTest::CCM_Client_impl::test_connections(void)
{
