...
#ifndef INCL_CDMW_QUALIF_FT_MANAGER_STARTER_HPP 
#define INCL_CDMW_QUALIF_FT_MANAGER_STARTER_HPP
...
class FTManagerStarter : public ProcessStarter
{
    private:
        static const std::string FT_MANAGER_EXE;
        static const std::string FT_MANAGER_CORBALOC;
    
    
    public:
        
        FTManagerStarter(const std::string& args,
                         CORBA::ORB_ptr orb);
