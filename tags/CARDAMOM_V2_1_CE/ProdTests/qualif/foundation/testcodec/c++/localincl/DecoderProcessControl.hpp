...
#ifndef INCL_DECODER_PROCESS_CONTROL_HPP 
#define INCL_DECODER_PROCESS_CONTROL_HPP 
...
class DecoderProcessControl : public Cdmw::CdmwInit::ProcessControl
{
  public:

    DecoderProcessControl(CORBA::ORB_ptr orb)
        throw(CORBA::SystemException);
        
        
    
    ~DecoderProcessControl()
        throw();
...
};  // End class DecoderProcessControl


}; // End namespace TestCodec
}; // End namespace Cdmw

#endif // INCL_DECODER_PROCESS_CONTROL_HPP
