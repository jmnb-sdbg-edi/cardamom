...
//
public class LocalDisplayImpl extends com.acme.BasicDemo.DisplayPOA 
{
    
    public LocalDisplayImpl() {}
    ...
    public void print(String text) {
        ...
        System.out.println("From LocalDisplay: " + text);
    }
    ...
    public void print_event(com.acme.BasicDemo.Event event) {
        // print the message on the default output
        System.out.println("From LocalDisplay: " + event.text);
    }
