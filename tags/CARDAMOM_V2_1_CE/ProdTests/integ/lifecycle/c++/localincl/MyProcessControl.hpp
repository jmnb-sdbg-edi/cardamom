...
#ifndef INCL_LIFECYCLE_MY_PROCESS_CONTROL_HPP
#define INCL_LIFECYCLE_MY_PROCESS_CONTROL_HPP

#include "Foundation/orbsupport/CORBA.hpp"
#include "lifecycle/ClientThread.hpp"
...
*
*/
class MyProcessControl : public Cdmw::CdmwInit::ProcessControl
{
public:
...
private:
    ...
    std::istream &                           m_is;
    std::ostream &                           m_os;
    Cdmw::LifeCycle::ClientThread *         m_client_thread;
};  // End class MyProcessControl

}; // End namespace LifeCycle
}; // End namespace Cdmw

#endif // INCL_LIFECYCLE_MY_PROCESS_CONTROL_HPP
