...
<softpkg name="Server" version="1,0,1,0">
    ...
    <idl id="IDL:acme.com/BasicDemo/Server:1.0" >
    ...
    <implementation id="DCE:700dc518-0110-11ce-ac8f-0800090b5d3e">
        ...
        <code type="Java Class">
            <fileinarchive name="libcdmwServerBasicDemo.jar"/>
            <entrypoint>cdmw.basicdemo.CCMServerHomeImpl.createCCMServerHome</entrypoint>
        </code>
