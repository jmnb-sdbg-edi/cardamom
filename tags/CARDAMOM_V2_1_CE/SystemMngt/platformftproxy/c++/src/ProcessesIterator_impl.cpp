...
ProcessesIterator_impl::ProcessesIterator_impl(CORBA::ORB_ptr orb,
...
ProcessesIterator_impl::~ProcessesIterator_impl () throw ()
{        
...
ProcessesIterator_impl::getTarget() 
 ...
 */
CORBA::Boolean 
ProcessesIterator_impl::next_one(CdmwPlatformMngt::Process_out entity)
    throw(CORBA::SystemException)
{
    CdmwPlatformMngt::ElementPathsIterator_var target = this->getTarget();
    ...
    if (succeed) {
	entity = m_proxy_collection->createProcessRef(element_path.ptr());
    }
 ...
 */
CORBA::Boolean 
ProcessesIterator_impl::next_n(CORBA::ULong how_many,
    ...
    throw(CORBA::SystemException)
{
    ...
    if (succeed) {
	entities = m_proxy_collection->createProcessesFromSeq(element_paths.ptr());
    }
 ...
 */
void 
ProcessesIterator_impl::destroy()
    throw(CORBA::SystemException) 
{
    CdmwPlatformMngt::ElementPathsIterator_var target = this->getTarget();
