...
#ifndef INCL_PLATFORMMNGT_APPLICATION_ACCESSOR_IMPL_HPP
#define INCL_PLATFORMMNGT_APPLICATION_ACCESSOR_IMPL_HPP
 ...
 *<p>
 */
class ApplicationAccessor_impl : public virtual POA_CdmwFTSystMngt::ApplicationAccessor,
...
private:
    ...
    /**
     *Purpose:
     *<p> Get the Application object.
     */
    CdmwPlatformMngt::Application_ptr get_application (const char* target_element_path)
     ...
     */
    ApplicationAccessor_impl(
        ApplicationAccessor_impl& rhs);

    /**
     * Purpose:
     * <p> Assignment operator is not allowed.
     */ 
    ApplicationAccessor_impl& operator=(
        const ApplicationAccessor_impl& rhs);
...
public:
     ...
     */
    virtual ~ApplicationAccessor_impl();
...
public:
     ...
     * operation
     */
    CORBA::ULong get_number_of_processes( const char* target_element_path) 
...
#endif //INCL_PLATFORMMNGT_APPLICATION_ACCESSOR_IMPL_HPP
