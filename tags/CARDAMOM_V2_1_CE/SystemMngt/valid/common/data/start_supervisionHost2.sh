...
echo "cdmw_platform_supervision_starter --CdmwXMLFile=CdmwPlatformMngtSystemStartHost2.xml --validate $*"
cdmw_platform_supervision_starter --CdmwXMLFile=CdmwPlatformMngtSystemStartHost2.xml --validate $*
else
