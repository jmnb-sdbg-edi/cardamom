...
echo "cdmw_platform_supervision_starter --CdmwXMLFile=CdmwPlatformMngtSystemStart-V-SMG-004.xml --validate $*"
cdmw_platform_supervision_starter --CdmwXMLFile=CdmwPlatformMngtSystemStart-V-SMG-004.xml --validate $*
else
