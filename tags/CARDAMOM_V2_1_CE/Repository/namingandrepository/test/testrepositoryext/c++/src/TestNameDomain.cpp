 ...
 : Testable(name)
{
    ...
    m_repository = CdmwNamingAndRepository::RepositoryExt::_duplicate(repository);
...
void TestNameDomain::do_tests()
{
    ...
    try
    {
        m_repository->register_new_object("dom1/X", obj1.in());
        TEST_SUCCEED();
    }
    ...
    // ---------------
    TEST_INFO("Try to reserve the name \"Z\" within \"dom1\"");
    
    try
    {
        CdmwNamingAndRepository::NameDomain::RegistrationId_var regId =
            m_repository->new_name("dom1/Z");
        TEST_SUCCEED();
    }
    ...
    try
    {
        m_repository->register_new_object("dom1/dom1_O1", obj1.in());
    ...
    {
        CdmwNamingAndRepository::NameDomain::RegistrationId_var regId =
            m_repository->new_name("dom1/dom1_O1");
        TEST_FAILED();
    }
    catch(const CdmwNamingAndRepository::NameDomain::AlreadyExists &e)
    {
    ...
    {
        CdmwNamingAndRepository::NameDomain::RegistrationId_var regId = 
            m_repository->new_name("dom1/dom1_O2");
    ...
    try
    {
        m_repository->register_new_factory("dom1/dom1_F1", fac1.in());
    ...
    {
        CdmwNamingAndRepository::NameDomain::RegistrationId_var regId = 
            m_repository->new_name("dom1/dom1_F2");
        m_repository->register_factory(regId.in(), fac2.in());
    ...
    try
    {
        m_repository->register_new_factory("dom1/dom2/dom2_F3", fac3.in());
    ...
    try
    {
        m_repository->register_new_factory("dom1/F4", fac4_1.in());
    ...
    try
    {
        ...
        m_repository->register_new_factory("dom1/dom2/F4", fac4_2.in());
    ...
    try
    {
        ...
        m_repository->register_new_factory("dom1/dom2/dom3/F4", fac4_3.in());
    ...
    try
    {
        m_repository->register_new_name_domain("dom1/dom2/user_dom", ndDesc);
    ...
    try
    {
        m_repository->register_new_object("dom1/dom2/user_dom/user_dom_O1",
                                          user_dom_O1.in());
    ...
    try
    {
        m_repository->register_new_factory("dom1/dom2/user_dom/user_dom_F1",
                                           user_dom_F1.in());
