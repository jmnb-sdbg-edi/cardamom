               ...
               CORBA::SystemException)
{
    try
    {
        CdmwPlatformMngt::Application_var application = 
                    m_system->get_application (service_provider.application_name);
                    
        CdmwPlatformMngt::ProcessProxy_var processProxy =
                    application->get_process (service_provider.process_name);
                    
        CORBA::Object_var serviceObject =  processProxy->embedded_service();
