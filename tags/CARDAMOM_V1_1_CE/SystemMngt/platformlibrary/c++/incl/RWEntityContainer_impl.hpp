...
*
*/
class RWEntityContainer_impl : virtual public EntityContainer_impl,
                               virtual public POA_CdmwPlatformMngtEntity::RWEntityContainer
{
    ...
    public:
		...
		* 
		*@param entity_name name of entity to add
		*
		*@exception CdmwPlatformMngtEntity::EntityAlreadyExists
		...
		*/
        ...
        /**
		* Purpose:
		* <p> Set status of entity in container
		* 
		*@param entity_name   name of entity
		*@param entity_status entity status
		*@param entity_info   entity info
		*
		*@exception CdmwPlatformMngtEntity::EntityNotFound
		*
		*/ 
		void set_entity_status(const char* entity_name,
