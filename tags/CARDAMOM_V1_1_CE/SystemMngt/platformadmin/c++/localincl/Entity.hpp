...
{
private:
    CdmwPlatformMngtEntity::RWEntityContainer_var m_entity_container;

protected:
    EntityContainer(
        CdmwPlatformMngtEntity::RWEntityContainer_ptr entity_container );
