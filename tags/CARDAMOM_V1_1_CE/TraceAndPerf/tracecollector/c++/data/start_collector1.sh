...
#----------------------------------------------------------------------
#  This shell script launches the 2nd Trace Collector  
#----------------------------------------------------------------------
usage()
{
    ...
    echo "Description:"
    echo "      This program starts the 2nd Trace Collector."
}
...
$TRACECOLLECTOR_EXE --interactive --collector-name=collector_1 --traceFile-name=tracelog1 --CdmwLocalisationService=$COLPORT1 --CdmwProcessPort=$COLPORT2 --namingRepos-url=$REPOSITORY_URL
