...
*
*/
class TestEventChannelConfiguration : public TestUtils::Testable
{
    ...
    public:
        ...
        *@exception
        */ 
        TestEventChannelConfiguration(std::string XMLFileName, bool do_validate)
                throw();
        ...
        *@exception
        */ 
        TestEventChannelConfiguration(const TestEventChannelConfiguration& rhs)
                throw();
        ...
        */ 
        TestEventChannelConfiguration&
        operator=(const TestEventChannelConfiguration& rhs)
                throw();
    ...
    private:
         EventChannelConfiguration* m_conf;
         std::string m_xmlFile;
         bool        m_doValidate;

}; // End class TestEventChannelConfiguration
