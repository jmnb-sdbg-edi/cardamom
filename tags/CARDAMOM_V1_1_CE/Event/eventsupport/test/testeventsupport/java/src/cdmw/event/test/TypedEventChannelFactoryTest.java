...
public class TypedEventChannelFactoryTest extends Testable {

    public static final String CHANNEL_1_NAME = "TestTypedEventChannel1";
    public static final String CHANNEL_2_NAME = "TestTypedEventChannel2";
    public static final String MIS_URL_CHANNEL_NAME = "TestTypedEventChannel3";
    public static final String UNDEF_XML_CHANNEL_NAME = "TestTypedEventChannel4";
    public static final String INV_CHANNEL_NAME = "Test/EventChannel4";

    /**
     * [Attribute description]
     */
    private TypedEventChannelFactory factory;
     ...
     *@exception
     */ 
    public TypedEventChannelFactoryTest(TypedEventChannelFactory factory) {
        this.name = "TypedEventChannelFactoryTest";
        this.out = System.out;
        this.testNumber = 1;
    ...
    public void doTests() {
        ...
        try {        
            switch (testNumber) {
            case 1 :
                out.println("Creating a new typed channel CHANNEL 1 "
                ...
                try {
                    ...
                    testOk = true;
                    out.println("CORBA exception raised: " + ce.reason);
            ...
            case 3:
                out.println("Creating a new typed channel CHANNEL 4 "
                    + "undefined in the XML file, should raised Creation error");
                testOk = false;
                try {
                ...
                out.println("Creating a new typed channel CHANNEL 2");
                testOk = false;
                try {
                ...
                out.println("Creating a new typed channel CHANNEL 3 with no URL defined => should raise CreationError exception ");
                testOk = false;
                try {
