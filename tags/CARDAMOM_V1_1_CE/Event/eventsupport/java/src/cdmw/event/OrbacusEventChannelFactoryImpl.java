...
/**
 * Implementation of the EventChannelFactory interface.
 *
 */
public class OrbacusEventChannelFactoryImpl 
    extends com.thalesgroup.CdmwEvent.EventChannelFactoryPOA {
    ...
    /**
     * Name of the default event channel factory
     */
    public static final String DEFAULT_EVENT_CHANNEL_FACTORY 
        = "DefaultEventChannelFactory";

    /**
     * Supported interface
     */
    public static final String EVT_CHANNEL_REP_ID 
     ...
     */ 
    public OrbacusEventChannelFactoryImpl(ORB orb, POA parent, NameDomain nameDomain, 
    ...
    public org.omg.CosEventChannelAdmin.EventChannel 
        ...
        com.ooc.OBEventChannelFactory.EventChannelFactory factory = null;
        org.omg.CORBA.Object obj;

        System.out.println("INFO: begin creation untyped channel named: " + name );
        ...
        org.omg.CORBA.Any regId = 
            OrbacusEventChannelUtils.registerName(domain, name);  
        ...
        try {
            obj = OrbacusEventChannelUtils.findOBFactory(orb, name, 
                DEFAULT_EVENT_CHANNEL_FACTORY);
            factory = com.ooc.OBEventChannelFactory.
        ...
        try {
            EventChannelInterface eventChannelInt 
                = new EventChannelInterface(channel);
            org.omg.CosEventComm.PushConsumer proxyConsumer 
                = eventChannelInt.getPushConsumer(notifier);
        } catch (Exception e) {
            channel.destroy();
            unreg.destroy();
            throw new com.thalesgroup.CdmwEvent.CreationError(
                "Impossible to connect channel destruction notifier");
        }
    ...
    public boolean supports(String repositoryId) {
        return repositoryId.equals(EVT_CHANNEL_REP_ID);
    }
