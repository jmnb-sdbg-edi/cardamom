...
#ifndef INCL_ELEMENTDESCRIPTION_IMPL_HPP
#define INCL_ELEMENTDESCRIPTION_IMPL_HPP
...
namespace Cdmw
{
    ...
    */
    ...
    namespace XMLUtils
    {
        ...
        class ElementDescription_impl : public virtual OBV_CdmwXML::ElementDescription,
                    public virtual CORBA::DefaultValueRefCountBase
        {

            protected:

                ElementDescription_impl();
                ElementDescription_impl(CdmwXML::NodeType type,
                                        CdmwXML::Node_ptr reference,
                                        const CdmwXML::DOMString& name);

                friend class ElementDescriptionFactory_impl;
