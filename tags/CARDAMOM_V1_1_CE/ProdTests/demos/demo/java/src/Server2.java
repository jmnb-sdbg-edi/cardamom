...
public class Server2 {
    ...
    public static final String TYPED_CHANNEL_NAME = "TypedEventChannel2";
    public static final String COMPLETE_TYPED_CHANNEL_NAME = "EVENT_CHANNELS/TypedEventChannel2";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            cdmw.cdmwinit.CdmwInterface.cdmwInit(orb, args, ctrl,
                "cdmw.generated.Server2CdmwInterface");
