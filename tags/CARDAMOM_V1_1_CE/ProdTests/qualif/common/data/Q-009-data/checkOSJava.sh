...
# List of files including OS Java API calls
RESULTFILE=$TEST.OS-Java.txt

# CARDAMOM ROOT Directory
ROOT="../../../../.."

echo " "
echo "Processing data for test $TEST (OS-Java)"
echo " "

echo "List of files including references to OS-Java API" > $RESULTFILE
echo "=================================================" >> $RESULTFILE
echo " "  >> $RESULTFILE
...
echo "Processing data for test $TEST (OS-Java) completed";
