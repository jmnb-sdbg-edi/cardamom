...
public class RecursiveMutex {
    ...
    /**
     * Number of call of the lock method
     */
    private int count = 0;

    /**
     * Lock the Mutex. Once a thread has a lock, it
    ...
    /**
     * Unlock the Mutex, if other threads are waiting for
     * the mutex, one of them is allowed to acquire the mutex,
     * only if count is equal to 0.
     */
