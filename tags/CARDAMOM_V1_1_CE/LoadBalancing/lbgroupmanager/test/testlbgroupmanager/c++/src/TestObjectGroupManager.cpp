...
TestObjectGroupManager::setUp()
{
    ...
    Cdmw::HelloInterface1_impl* obj3_impl = new Cdmw::HelloInterface1_impl();

    // create an object hello2
    Cdmw::HelloInterface2_impl* obj2_impl = new Cdmw::HelloInterface2_impl();
...
TestObjectGroupManager::locations_of_members()
{
    ...
    for (CORBA::ULong i = 0; i<locations->length(); i++)
        {
            const std::string loc = Cdmw::NamingAndRepository::NamingInterface::to_string(locations[i]);
