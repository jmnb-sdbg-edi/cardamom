...
#ifndef INCL_CDMW_LB_STRATEGY_FACTORY_IMPL_H
#define INCL_CDMW_LB_STRATEGY_FACTORY_IMPL_H
...
namespace LB
{
    ...
    class StrategyFactory_impl : public CdmwLB::StrategyFactory
    {
    public:
        // Constructor.
        StrategyFactory_impl(Cdmw::LB::IOGRFactory* iogr_factory);

        // Destructor
        ~StrategyFactory_impl();
        /**
         * Methods required by the cardamom::lb::Strategy interface.
         */
...
#endif // INCL_CDMW_LB_STRATEGY_FACTORY_IMPL_H
