...
class ComponentGroupRef
    extends ComponentInstantiationRef
{
    /**
     * Constructor.
     *
     ...
     */
    public ComponentGroupRef(ComponentGroup componentGroup) {
        super(componentGroup);
    }
    
    ComponentGroup getComponentGroup() {
        cdmw.common.Assert.check(getComponent() instanceof ComponentGroup);
