...
$TERM -ls -sb -sl 500 -e ./helloServer.sh --namingRepos-url=corbaloc::localhost:42562/CdmwRepository &
HELLO_SERVER_PID=$!
sleep $INIT_TIMEOUT

# 3) Start HelloClient
$echo Starting the Hello Client...
$TERM -ls -sb -sl 500 -e ./helloClient.sh --namingRepos-url=corbaloc::localhost:42562/CdmwRepository &
HELLO_CLIENT_PID=$!
...
read FOO
$echo "============================="
kill -9 $HELLO_SERVER_PID $HELLO_CLIENT_PID $REPOSITORY_PID
$echo "done."
