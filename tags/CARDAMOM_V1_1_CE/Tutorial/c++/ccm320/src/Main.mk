...
ALL_LIBS=$(LIBS) $(LDFLAGS_CSC) -lTAO_CosLoadBalancing -lTAO_PortableGroup
...
CLIENT_NAME=client
SERVER_NAME=component_server
LIB_SERVER_NAME=libServerHello.so
GRP_CREATOR_NAME=lb_group_creator
...
CDMW_GEN_GRP_CREATOR_SRC=LBGroupCreatorCdmwInterface.cpp
CDMW_GEN_SERVER_COMMON_SRC=
CDMW_GEN_SERVER_SRC=CdmwInterface.cpp
...
MANUAL_ASSEMBLY_SRC=$(CDMW_GEN_GRP_CREATOR_SRC) \
	manual_assembly.cpp MyComponentInstallation.cpp

SERVER_SRCS=$(SERVERS_COMMON_SRC) \
	$(CDMW_GEN_SERVER_SRC) \
	$(CDMW_GEN_SERVER_COMMON_SRC) \
...
SRCS= $(SERVER_SRCS) $(CLIENT_SRCS) $(LIB_SERVER_SRCS) $(GRP_CREATOR_SRCS) $(CORBA_SRV_ALL_SRC)
DEPENDS=$(SRCS:.cpp=.d)

.PHONY: all
all: depend  $(LIB_SERVER_NAME)  $(SERVER_NAME) $(MANUAL_ASSEMBLY_NAME) $(GRP_CREATOR_NAME) $(CLIENT_NAME)
...
cleanall: clean
	-$(RM) $(SERVER_NAME) $(LIB_SERVER_NAME) $(MANUAL_ASSEMBLY_NAME) $(CLIENT_NAME) $(GRP_CREATOR_NAME)
