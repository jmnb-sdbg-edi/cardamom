...
SERVER1_NAME=observer
SERVER2_NAME=process
...
CONSOLE_OBJ = $(CONSOLE_SRCS:.cpp=.o) $(CORBA_SRV_ALL_OBJS)
...
SRCS=$ $(CONSOLE_SRCS) $(SERVER1_SRCS) $(SERVER2_SRCS) $(CORBA_SRV_ALL_SRC)
DEPENDS=$(SRCS:.cpp=.d)

.PHONY: all
all: depend  $(CONSOLE_NAME) $(SERVER1_NAME) $(SERVER2_NAME)
...
$(CONSOLE_NAME): $(CONSOLE_OBJ)
	$(PURIFY) $(CXXLD) $(CXXFLAGS) $(LDFLAGS) -o $@ \
	$(CONSOLE_OBJ)  $(ALL_LIBS)
...
cleanall: clean
	-$(RM) $(SERVER1_NAME) $(SERVER2_NAME) $(CONSOLE_NAME)
