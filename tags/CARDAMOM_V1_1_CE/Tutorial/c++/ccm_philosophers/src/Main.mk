...
LIB_PHILOSOPHER_SRCS=\
    PhilosopherHomeExecutor_impl.cpp PhilosopherExecutor_impl.cpp \
    StatusInfo_impl.cpp

LIB_FORK_MANAGER_SRCS=\
    ForkManagerHomeExecutor_impl.cpp ForkManagerExecutor_impl.cpp \
    ForkFacetExecutor_impl.cpp

LIB_OBSERVER_SRCS=\
    ObserverHomeExecutor_impl.cpp ObserverExecutor_impl.cpp \
    StatusInfo_impl.cpp

LIB_REGISTRATOR_SRCS=\
    RegistratorHomeExecutor_impl.cpp RegistratorExecutor_impl.cpp 
...
GENERATED_FORK_MANAGER_SRCS=\
    ...
    SessionForkManager_impl.cpp SessionForkManagerHome_impl.cpp  \
    Fork_impl.cpp
...
GREEK_SERVER_SRCS=\
    main_componentserver.cpp GreekSchoolcdmwInterface.cpp \
    $(GENERATED_PHILOSOPHER_SRCS) $(GENERATED_FORK_MANAGER_SRCS)

FRENCH_SERVER_SRCS=\
    main_componentserver.cpp FrenchSchoolcdmwInterface.cpp \
    $(GENERATED_PHILOSOPHER_SRCS) $(GENERATED_FORK_MANAGER_SRCS) \
    $(GENERATED_REGISTRATOR_SRCS)

OBSERVER_SERVER_SRCS=\
    main_componentserver.cpp ObserverCdmwInterface.cpp \
    $(GENERATED_OBSERVER_SRCS)
...
SRCS=$ $(LIB_PHILOSOPHER_SRCS) $(LIB_FORK_MANAGER_SRCS) \
       $(LIB_OBSERVER_SRCS) $(LIB_REGISTRATOR_SRCS) \
       $(FRENCH_SERVER_SRCS) $(GREEK_SERVER_SRCS) $(OBSERVER_SERVER_SRCS)\
       $(CORBA_SRV_ALL_SRC)
