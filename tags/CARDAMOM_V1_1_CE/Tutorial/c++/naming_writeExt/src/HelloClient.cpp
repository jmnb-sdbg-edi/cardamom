...
{    
    ...
    try 
    {
        ...
        try
        {
            ni_defRoot.bind ("HelloInterfaceMike",helloInterfaceMike.in(),true);
            
            std::cout << ">>>> successful binding of HelloInterface for Mike \n"
                      << "     in the default root context" << std::endl;
        }
        catch(...)
        {
            std::cout << ">>>> Error in creation of HelloInterface for Mike \n"
                      << "     in the default root context" << std::endl;
        }
