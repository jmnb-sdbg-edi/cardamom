...
#ifndef INCL_CCM_CIF_PORTDESCRIPTION_IMPL_HPP
#define INCL_CCM_CIF_PORTDESCRIPTION_IMPL_HPP
...
class PortDescriptionFactory : virtual public CORBA::ValueFactoryBase
{
    virtual CORBA::ValueBase* create_for_unmarshal();

public:
    PortDescriptionFactory();
    virtual ~PortDescriptionFactory();
};
...
#endif // INCL_CCM_CIF_PORTDESCRIPTION_IMPL_HPP
