...
cp $PARENT_DIR/data/Dinner.cad $PACK_TMP_DIR/meta-inf
...
# copy idl file
echo idl...
cp $PARENT_DIR/idl/Philo.idl $PACK_TMP_DIR

# make links for libraries
ln -s $PARENT_DIR/$HOST_TYPE/libphilosopher.jar $PACK_TMP_DIR/libphilosopher.jar
ln -s $PARENT_DIR/$HOST_TYPE/libforkmanager.jar $PACK_TMP_DIR/libforkmanager.jar
ln -s $PARENT_DIR/$HOST_TYPE/libobserver.jar $PACK_TMP_DIR/libobserver.jar
ln -s $PARENT_DIR/$HOST_TYPE/libregistrator.jar $PACK_TMP_DIR/libregistrator.jar
