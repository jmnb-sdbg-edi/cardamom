...
SERVER_SRCS=$(SERVERS_COMMON_SRC) \
	$(CDMW_GEN_SERVER_SRC) \
	$(CDMW_GEN_SERVER_COMMON_SRC) \
	main_componentserver.cpp CdmwInterface.cpp \
...
SRCS=$ $(LIB_CLIENT_SRCS) $(SERVER_SRCS) $(CORBA_SRV_ALL_SRC)
DEPENDS=$(SRCS:.cpp=.d)

.PHONY: all
all: depend  $(LIB_CLIENT_NAME) $(SERVER_NAME) $(PACKAGING)
...
cleanall: clean
	-$(RM) $(SERVER_NAME) $(LIB_CLIENT_NAME)
