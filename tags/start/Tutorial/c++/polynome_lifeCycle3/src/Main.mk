...
CLIENT_NAME=polynomeClient
SERVER_NAME=polynomeServer


# CARDAMOM Generated Code
CDMW_GEN_CLIENT_SRC=PolynomeClientCdmwInterface.cpp
CDMW_GEN_SERVER_SRC=PolynomeServerCdmwInterface.cpp \
                     PolynomeServantProvider.cpp \
                     PolynomeSessionFactory_impl.cpp
...
SERVER_SRCS=$(CDMW_GEN_SERVER_SRC) \
            PolynomeUserServantProvider.cpp \
            NoRootsBinome_impl.cpp \
            SingleRootBinome_impl.cpp \
            TwoRootsBinome_impl.cpp \
	        PolynomeServer.cpp
	        
CLIENT_SRCS=$(CDMW_GEN_CLIENT_SRC) \
	        PolynomeClient.cpp \
	        PolynomeClientThread.cpp \
	        PolynomeClientProcessControl.cpp
