...
HelloInterface_impl::HelloInterface_impl(const Cdmw::LifeCycle::ObjectDeactivator & obj_d)
    throw(CORBA::SystemException)
    : Cdmw::LifeCycle::LifeCycleSingleObject(obj_d)
{ 
    std::cout << "<# HelloInterface servant constructed #>" << std::endl;
}
...
HelloInterface_impl::~HelloInterface_impl()
    throw()
{
    std::cout << "<# HelloInterface servant destroyed #>" << std::endl;
}
