...
// forward declaration
class ClientExecutor_impl;


class ClientActivationThread : public Cdmw::OsSupport::Thread 
{
  public:
  
    ClientActivationThread(ClientExecutor_impl* p_client);

    ~ClientActivationThread() throw();
  ...
  private:
    ...
    ClientActivationThread();
    ClientActivationThread(const ClientActivationThread&);
    ClientActivationThread& operator = (const ClientActivationThread&);
    
    ClientExecutor_impl* m_client;
};
...
{
  friend class ClientActivationThread;
  ...
  public:
    ...
    //
    // IDL:thalesgroup.com/Hello/CCM_Client/push_received_info:1.0
    //
  ...
  private:
    ...
    ClientActivationThread*  m_activation_thread;
