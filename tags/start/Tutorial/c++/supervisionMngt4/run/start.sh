...
$TERM -ls -sb -sl 500 -e $DIRECTORY/../$HOST_TYPE/observer --CdmwLocalisationService=21872 &
SUPERVISION_OBSERV_PID=$!
sleep $INIT_TIMEOUT

# 4) Start Platform Management Supervision Console
$echo Starting the Platform Management Supervision Console...
$TERM -ls -sb -sl 500 -e $DIRECTORY/../$HOST_TYPE/console &
SUPERVISION_CONSOLE_PID=$!
...
$DAEMON_COMMAND stop
kill -9 $SUPERVISION_CONSOLE_PID $SUPERVISION_OBSERV_PID $SUPERVISION_PID
if test -x "$CDMW_HOME/bin/cdmw_ft_manager"
then
