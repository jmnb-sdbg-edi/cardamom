...
//
void 
TestFtCcmCif::CCM_ComponentWithConsumer_impl::push_the_consumer (TestEvent* event)
    ...
    throw(CORBA::SystemException)
{
    ...
    m_session_context = ::TestFtCcmCif::CCM_ComponentWithConsumer_Context::_narrow(ctx); 
}
