...
#ifndef INCL_TEST_WRITE_SEQUENCING_HPP
#define INCL_TEST_WRITE_SEQUENCING_HPP
...
class TestWriteSequencing : virtual public Cdmw::TestUtils::Testable
{
public:
    // constructor
    TestWriteSequencing(
...
#endif // INCL_TEST_WRITE_SEQUENCING_HPP
