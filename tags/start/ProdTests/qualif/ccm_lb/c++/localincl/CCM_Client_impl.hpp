                        ...
                        virtual Cdmw::TestUtils::Testable
{
    private:
        ...
        CORBA::String_var m_expectedReplica1Hostname;
        CORBA::String_var m_expectedReplica2Hostname;
    ...
    public:
        ...
        //
        virtual char*
        expectedReplica1Hostname()
            throw(CORBA::SystemException);

        virtual void
        expectedReplica1Hostname(const char* a)
            throw(CORBA::SystemException);
        ...
        //
        virtual char*
        expectedReplica2Hostname()
            throw(CORBA::SystemException);

        virtual void
        expectedReplica2Hostname(const char* a)
            throw(CORBA::SystemException);
