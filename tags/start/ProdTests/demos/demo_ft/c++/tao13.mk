...
# -------------------------------------------------------------------------------
CPPFLAGS_tao13= -I$(ACE_ROOT) -I$(TAO_ROOT) -I$(TAO_ROOT)/orbsvcs -I$(TAO_ROOT)/tao/IFR_Client -I$(TAO_ROOT)/orbsvcs/orbsvcs/IFRService \
...
CXXFLAGS_tao13=
IDLFLAGS_tao13= -I$(TAO_ROOT)/TAO_IDL/idl_specs -I$(TAO_ROOT) -I$(TAO_ROOT)/tao -I$(TAO_ROOT)/orbsvcs -I$(TAO_ROOT)/tao/IFR_Client
...
LIBS_tao13:= -lTAO_CosEvent -lTAO_CosProperty -lTAO -lTAO_PortableServer -lTAO_CosNaming -lTAO_Strategies -lTAO_Messaging -lTAO_RTCORBA -lACE -lTAO_IFR_Client \
	-lTAO_FaultTolerance -lTAO_CosNotification -lTAO_IORManip -lTAO_FTORB
