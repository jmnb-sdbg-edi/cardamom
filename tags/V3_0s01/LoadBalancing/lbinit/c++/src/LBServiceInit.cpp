...
namespace LB
{
    ...
    void LBServiceInit::Init(int argc,char* argv[])throw(CORBA::SystemException)
    {
        ...
        {
	    std::cerr << "ERROR: It is necessary to specify the option --LBInterceptorSide with one of the following values: " << std::endl;
	    std::cerr << "       1. Client " << std::endl;
            std::cerr << "       2. Server " << std::endl;
            std::cerr << "       3. LBGroupManager " << std::endl;
