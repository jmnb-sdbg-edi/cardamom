...
#ifndef __CDMW_LB_CDMW_TYPE_REPOSITORY_IMPL_HPP__
#define __CDMW_LB_CDMW_TYPE_REPOSITORY_IMPL_HPP__

#include "Foundation/orbsupport/CORBA.hpp"
#include "Foundation/orbsupport/RefCountLocalObject.hpp"
#include "LoadBalancing/idllib/CdmwLBTypeRepository.skel.hpp"
#include <list>
#include <map>
...
class TypeRepository_impl : virtual public CdmwLB::TypeRepository, 
...
public:
    ...
    CORBA::Boolean has_base_interface(const char* type_id, const char* base_type_id)
        throw(::CdmwLB::TypeRepository::TypeNotFound);
...
#endif // __CDMW_LB_CDMW_TYPE_REPOSITORY_IMPL_HPP__
