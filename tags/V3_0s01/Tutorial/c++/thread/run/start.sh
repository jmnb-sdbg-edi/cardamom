...
then
    ...
    $TERM -ls -sb -sl 500 -e $CDMW_HOME/bin/cdmw_ft_manager --CdmwXMLFile=../data/CdmwFaultToleranceManager_conf.xml --groupConf=../data/CdmwFTSystemMngtGroupCreator_conf.xml &
    FT_MANAGER_PID=$!
    sleep $FT_MANAGER_TIMEOUT
fi

# 2a) Start Platform Management Supervision
...
$TERM -ls -sb -sl 500 -e $CDMW_HOME/bin/cdmw_platform_supervision_observer --register --system-corbaloc=corbaloc::$HOSTNAME:21880/CdmwPlatformMngtSupervision --observer-name=observer &
...
$CDMW_HOME/bin/cdmw_platform_admin --system-corbaloc=corbaloc::$HOSTNAME:21880/CdmwPlatformMngtSupervision --sys-define $SCENARIO_FILE
sleep $INIT_TIMEOUT

# 5) Start_system
$echo Starting the System
$CDMW_HOME/bin/cdmw_platform_admin --system-corbaloc=corbaloc::$HOSTNAME:21880/CdmwPlatformMngtSupervision --sys-start
if [ $? -eq "0" ];
then
...
$CDMW_HOME/bin/cdmw_platform_admin --system-corbaloc=corbaloc::$HOSTNAME:21880/CdmwPlatformMngtSupervision --sys-snapshot
...
$CDMW_HOME/bin/cdmw_platform_admin --system-corbaloc=corbaloc::$HOSTNAME:21880/CdmwPlatformMngtSupervision --sys-stop
