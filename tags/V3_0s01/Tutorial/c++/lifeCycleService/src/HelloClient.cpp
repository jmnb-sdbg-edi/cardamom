...
#include "HelloServiceFactory.stub.hpp"
...
{    
    ...
    try 
    {
        ...
        CdmwLifeCycle::FactoryBase_var factory = factoryFinder->find_factory (
                        "Hello.Domain/Hello.Factories/HelloService.factory");
                        
                        
	    HelloServiceFactoryModule::HelloServiceFactory_var hello_factory = 
	             HelloServiceFactoryModule::HelloServiceFactory::_narrow(factory.in());
