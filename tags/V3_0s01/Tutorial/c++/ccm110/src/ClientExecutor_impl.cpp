   ...
   throw(CORBA::SystemException)
{
    ...
    try
    {
        ...
        CORBA::Object_var objref1 = ni_defRoot.resolve ("MyNaming/Tutorial/HelloServer1");
        ...
        CORBA::Object_var objref2 = ni_defRoot.resolve ("MyNaming/Tutorial/HelloServer2");
        ...
        CORBA::Object_var objref3 = ni_defRoot.resolve ("MyNaming/Tutorial/HelloClient");
