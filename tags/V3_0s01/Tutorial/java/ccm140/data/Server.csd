...
<softpkg name="Server" version="1,0,1,0">
    ...
    <implementation id="DCE:700dc518-0110-11ce-ac8f-0800090b5d3e">
        ...
        <code type="Java Class">
            <fileinarchive name="libserver.jar"/>
            <entrypoint>Hello.ServerHomeFactory.createServerHomeExecutor</entrypoint>
        </code>

        <dependency type="Java Class">
            <valuetypefactory repid="IDL:acme.com/Hello/StatusInfo:1.0"
                              factoryentrypoint="Hello.StatusInfoFactory.createStatusInfoFactory">
                <fileinarchive name="libserver.jar"/>
            </valuetypefactory>
        </dependency> 
