    ...
    extends cdmw.tutorial.HelloServantProvider 
{
    ...
    *@return object id
    */
    public byte[] create_HelloInterface(String object_oid)
        throws org.omg.CORBA.SystemException
    {
        ...
        System.out.println("<<HelloUserServantProvider>> Hello '" +
    ...
    */    
                               ...
                               org.omg.PortableServer.Servant servant) 
    {
        ...
        // NOTE: As the servant is a TIE, it doesn't inherit itself from LifeCycleObjectBase.
        //       It's delagated object inherit from LifeCycleObjectBase.
        com.thalesgroup.Hello.HelloInterfacePOATie tie =
            (com.thalesgroup.Hello.HelloInterfacePOATie) servant;
        cdmw.lifecycle.LifeCycleObjectBase removable = 
            (cdmw.lifecycle.LifeCycleObjectBase) tie._delegate();
