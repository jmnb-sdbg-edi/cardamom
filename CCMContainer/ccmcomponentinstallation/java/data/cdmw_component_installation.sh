...
@CDMW_CCMCONTAINER_LIB_JAR_PATH@/lib@config.lowercase.product.name@ccmcomponentinstallation.jar:\
...
exec java -Xbootclasspath/p:$__CLASSPATH__ cdmw.ccm.deployment.ComponentInstallation $*
