...
public class MainTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String server_option = cdmw.ossupport.OS.getOptionValue(args, "--server");
            if (server_option.equals("no")) {
                ...
                MyComponentInstallation cmpInst = new MyComponentInstallation(rootPOA);
                com.thalesgroup.CdmwDeployment.ComponentInstallation
                    componentInstallation = cmpInst._this(orb);
                ...
                String componentServerIOR = orb.object_to_string(componentServer);
                java.io.FileWriter fw = new java.io.FileWriter("componentServer.ior");
                fw.write(componentServerIOR);
                fw.close();
