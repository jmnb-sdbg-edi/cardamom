...
@CDMW_CCMCONTAINER_LIB_JAR_PATH@/lib@config.lowercase.product.name@ccmserveractivator.jar:\
...
exec java -Xbootclasspath/p:$__CLASSPATH__ cdmw.ccm.serveractivator.ServerActivator $*
