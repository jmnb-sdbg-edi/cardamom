...
//
// IDL:thalesgroup.com/TestFtCcmCif/CCM_ComponentWithFacetHome:1.0
//
class CCM_ComponentWithFacetHome_impl : 
    virtual public CCM_ComponentWithFacetHome,
...
public:
    ...
    //
    // IDL:thalesgroup.com/TestFtCcmCif/CCM_ComponentWithFacetHomeImplicit/create:1.0
    //
