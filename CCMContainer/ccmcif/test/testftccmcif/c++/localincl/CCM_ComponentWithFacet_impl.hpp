    ...
    virtual public Cdmw::OrbSupport::RefCountLocalObject
{
    ...
    CCM_ComponentWithFacet_Context_var m_session_context;
...
public:
    ...
    CCM_ComponentWithFacet_Context* get_context()
    {
        return ::TestFtCcmCif::CCM_ComponentWithFacet_Context::_duplicate(m_session_context.in());
    }
