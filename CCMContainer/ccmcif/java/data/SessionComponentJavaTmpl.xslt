...
<!--
   ...
   @param none
-->
<xsl:template name="session_component_java">
   <!--
   ...
   <xsl:if test="boolean($lifecycleFrameworkNodes/home-impl) and $lifecycleFrameworkNodes/home-impl/@category = 'SESSION'">
      <xsl:if test="$_index &lt;= count($lifecycleFrameworkNodes/home-impl)">
         ...
         <xsl:if test="boolean($managedComponentNode)">
            <xsl:variable name="componentImplClassname" select="concat('Session', $managedComponentNode/@name, 'Impl')"/>
            ...
            <xsl:document method="text" href="{$filename}">
               ...
               <!--
                  Insert the content.
               -->
               <xsl:call-template name="session_component_java.content">
         ...
         -->
         <xsl:call-template name="session_component_java">
            <xsl:with-param name="_index" select="$_index + 1"/>
         </xsl:call-template>
      </xsl:if>
   </xsl:if>
</xsl:template> <!-- end of template session_component_java.content -->
...
-->
<xsl:template name="session_component_java.content">
   ...
   <xsl:variable name="componentImplClassname" select="concat('Session', $_componentName, 'Impl')"/>
...
public class Session<xsl:value-of select="$_componentName"/>Impl extends CCMObjectImpl
    ...
    public static final String COMP_NAME   = "<xsl:value-of select="$_componentName"/>";
      ...
      <xsl:call-template name="findAllJavaComponentFacets">
         <xsl:with-param name="_componentName" select="$_componentName"/>
         <xsl:with-param name="_template" select="'session_component_java.content.9'"/>
         <xsl:with-param name="_strategy" select="'Session'"/>
      </xsl:call-template>
      ...
      <xsl:call-template name="findAllJavaComponentReceptacles">
         <xsl:with-param name="_componentName" select="$_componentName"/>
         <xsl:with-param name="_template" select="'session_component_java.content.13'"/>
         <xsl:with-param name="_strategy" select="'Session'"/>
      </xsl:call-template>
      ...
      <xsl:call-template name="findAllJavaComponentPublishers">
         <xsl:with-param name="_componentName" select="$_componentName"/>
         <xsl:with-param name="_template" select="'session_component_java.content.15'"/>
         <xsl:with-param name="_strategy" select="'Session'"/>
      </xsl:call-template>
      ...
      <xsl:call-template name="findAllJavaComponentEmitters">
         <xsl:with-param name="_componentName" select="$_componentName"/>
         <xsl:with-param name="_template" select="'session_component_java.content.16'"/>
         <xsl:with-param name="_strategy" select="'Session'"/>
      </xsl:call-template>
      ...
      <xsl:call-template name="findAllJavaComponentConsumers">
         <xsl:with-param name="_componentName" select="$_componentName"/>
         <xsl:with-param name="_template" select="'session_component_java.content.19'"/>
         <xsl:with-param name="_strategy" select="'Session'"/>
      </xsl:call-template>
    ...
    private class <xsl:value-of select="$_componentName"/>ExecutorLocator 
        ...
        implements com.thalesgroup.CdmwCcmCif.SessionExecutorLocator {

        /**
         * indicates that the component executor inherits from the SessionComponent local interface.
         */
        private boolean isSessionComponent = false;
        ...
        public <xsl:value-of select="$_componentName"/>ExecutorLocator(<xsl:value-of select="$componentObjRefVar"/> executor) {
            ...
            try  {
                org.omg.Components.SessionComponent sessionComp
                    = org.omg.Components.SessionComponentHelper.narrow(this.compExecutor);
            
                if (sessionComp != null) {
                    isSessionComponent = true;
                }
            } catch (Exception e) {}
        }
         ...
         public org.omg.CORBA.Object obtain_executor(String name)
            ...
            <xsl:call-template name="findAllJavaComponentFacets">
               <xsl:with-param name="_componentName" select="$_componentName"/>
               <xsl:with-param name="_template" select="'session_component_java.content.10'"/>
               <xsl:with-param name="_strategy" select="'Session'"/>
            </xsl:call-template>
            <xsl:call-template name="findAllJavaComponentConsumers">
               <xsl:with-param name="_componentName" select="$_componentName"/>
               <xsl:with-param name="_template" select="'session_component_java.content.20'"/>
               <xsl:with-param name="_strategy" select="'Session'"/>
            </xsl:call-template>
            else {
         ...
         public void set_session_context(org.omg.Components.SessionContext ctx)
            ...
            if (isSessionComponent) {
               org.omg.Components.SessionComponent sessionComp 
                  = org.omg.Components.SessionComponentHelper.narrow(this.compExecutor);
               sessionComp.set_session_context(ctx);
            }
         }
    ...
    /**
     * executor locator must a session component to be advise 
     * of its activation, passivation and removal
     */
    private org.omg.Components.SessionComponent sessionLocator;
   ...
   <xsl:variable name="contextExecutorClassName">
      ...
      <xsl:value-of select="concat($tmpClassName, '_SessionContext')"/>
    </xsl:variable>
    /**
   ...
   <xsl:call-template name="findAllJavaInterfaceReadWriteAttributes">
      ...
      <xsl:with-param name="_template" select="'session_component_java.content.4'"/>
      <xsl:with-param name="_strategy" select="'Session'"/>
   </xsl:call-template>
     ...
     * Constructor
     */
    public Session<xsl:value-of select="$_componentName"/>Impl(
        String compOid,
        ...
        try {
            ...
            this.sessionLocator = org.omg.Components.SessionComponentHelper.narrow(this.executorLocator);

            if (this.sessionLocator == null) {
   			    System.err.println("Executor Locator should be a session component!");
   			    throw new org.omg.CORBA.BAD_PARAM(
        ...
        this.contextExecutor = new CCM_<xsl:value-of select="$_componentName"/>_SessionContextImpl(ctx, this);

      <xsl:call-template name="findAllJavaComponentFacets">
         <xsl:with-param name="_componentName" select="$_componentName"/>
         <xsl:with-param name="_template" select="'session_component_java.content.11'"/>
         <xsl:with-param name="_strategy" select="'Session'"/>
      </xsl:call-template>
      ...
      <xsl:if test="$hasReceptacles = 'true'">
         try {
            <xsl:call-template name="findAllJavaComponentReceptacles">
               <xsl:with-param name="_componentName" select="$_componentName"/>
               <xsl:with-param name="_template" select="'session_component_java.content.14'"/>
               <xsl:with-param name="_strategy" select="'Session'"/>
            </xsl:call-template>
      ...
      <xsl:if test="$hasEmitters = 'true' or $hasPublishers = 'true'">
         try {
            <xsl:if test="$hasPublishers = 'true'">
               <xsl:call-template name="findAllJavaComponentPublishers">
                  <xsl:with-param name="_componentName" select="$_componentName"/>
                  <xsl:with-param name="_template" select="'session_component_java.content.17'"/>
                  <xsl:with-param name="_strategy" select="'Session'"/>
               </xsl:call-template>
            </xsl:if>
            <xsl:if test="$hasEmitters = 'true'">
               <xsl:call-template name="findAllJavaComponentEmitters">
                  <xsl:with-param name="_componentName" select="$_componentName"/>
                  <xsl:with-param name="_template" select="'session_component_java.content.18'"/>
                  <xsl:with-param name="_strategy" select="'Session'"/>
               </xsl:call-template>
            </xsl:if>
         } catch (AlreadyDoneException ade) {
      ...
      <xsl:if test="$hasConsumers = 'true'">
         try {
            <xsl:call-template name="findAllJavaComponentConsumers">
               <xsl:with-param name="_componentName" select="$_componentName"/>
               <xsl:with-param name="_template" select="'session_component_java.content.21'"/>
               <xsl:with-param name="_strategy" select="'Session'"/>
            </xsl:call-template>
         } catch (AlreadyDoneException ade) {
   ...
   <xsl:call-template name="findAllJavaInterfaceReadWriteAttributes">
      <xsl:with-param name="_interfaceName" select="$_componentName"/>
      <xsl:with-param name="_type" select="'Component'"/>
      <xsl:with-param name="_template" select="'session_component_java.content.3'"/>
      <xsl:with-param name="_strategy" select="'Session'"/>
   </xsl:call-template>
   ...
   <xsl:call-template name="findAllJavaComponentFacets">
      <xsl:with-param name="_componentName" select="$_componentName"/>
      <xsl:with-param name="_template" select="'session_component_java.content.1'"/>
      <xsl:with-param name="_strategy" select="'Session'"/>
   </xsl:call-template>
   ...
   <xsl:call-template name="findAllJavaComponentReceptacles">
      <xsl:with-param name="_componentName" select="$_componentName"/>
      <xsl:with-param name="_template" select="'session_component_java.content.2'"/>
      <xsl:with-param name="_strategy" select="'Session'"/>
   </xsl:call-template>
   ...
   <xsl:call-template name="findAllJavaComponentConsumers">
      <xsl:with-param name="_componentName" select="$_componentName"/>
      <xsl:with-param name="_template" select="'session_component_java.content.5'"/>
      <xsl:with-param name="_strategy" select="'Session'"/>
   </xsl:call-template>
   ...
   <xsl:call-template name="findAllJavaComponentPublishers">
      <xsl:with-param name="_componentName" select="$_componentName"/>
      <xsl:with-param name="_template" select="'session_component_java.content.6'"/>
      <xsl:with-param name="_strategy" select="'Session'"/>
   </xsl:call-template>
   ...
   <xsl:call-template name="findAllJavaComponentEmitters">
      <xsl:with-param name="_componentName" select="$_componentName"/>
      <xsl:with-param name="_template" select="'session_component_java.content.7'"/>
      <xsl:with-param name="_strategy" select="'Session'"/>
   </xsl:call-template>
      ...
      if (this.configured == false) {
         if (!this.isCreatedByFactoryOperation) {
            <xsl:call-template name="findAllJavaInterfaceReadWriteAttributes">
               <xsl:with-param name="_interfaceName" select="$_componentName"/>
               <xsl:with-param name="_type" select="'Component'"/>
               <xsl:with-param name="_template" select="'session_component_java.content.8'"/>
               <xsl:with-param name="_strategy" select="'Session'"/>
            </xsl:call-template>
         }
         ...
         org.omg.Components.SessionComponent sessionLocator 
            = org.omg.Components.SessionComponentHelper.narrow(this.executorLocator);
        
         try {
             sessionLocator.set_session_context(this.contextExecutor);
             this.executorLocator.configuration_complete();
             sessionLocator.ccm_activate();
         } catch(org.omg.Components.CCMException ccme) {
      ...
      <xsl:when test="$hasFacets = 'true' or $hasConsumers = 'true'">
         public org.omg.PortableServer.Servant get_facet_servant(String facetName) {
            ...
            <xsl:if test="$hasFacets = 'true'">
               <xsl:call-template name="findAllJavaComponentFacets">
                  <xsl:with-param name="_componentName" select="$_componentName"/>
                  <xsl:with-param name="_template" select="'session_component_java.content.12'"/>
                  <xsl:with-param name="_strategy" select="'Session'"/>
               </xsl:call-template>
            </xsl:if>
            <xsl:if test="$hasConsumers = 'true'">
               <xsl:call-template name="findAllJavaComponentConsumers">
                  <xsl:with-param name="_componentName" select="$_componentName"/>
                  <xsl:with-param name="_template" select="'session_component_java.content.22'"/>
                  <xsl:with-param name="_strategy" select="'Session'"/>
               </xsl:call-template>
            </xsl:if>
            {
   ...
   protected void advise_executor_of_remove_component() {
      ...
      try {
         sessionLocator.ccm_passivate();
         sessionLocator.ccm_remove();
      } catch(org.omg.Components.CCMException ccme) {
         System.err.println("CCMException raised, reason: " + ccme.toString());
         throw new org.omg.CORBA.INTERNAL(
            ExceptionMinorCodes.INTERNAL,
...
<!--
-->
<xsl:template name="session_component_java.content.1">
...
</xsl:template> <!-- end of template session_component_java.content.1 -->



<!--
-->
<xsl:template name="session_component_java.content.2">
...
</xsl:template> <!-- end of template session_component_java.content.2 -->



<!--
-->
<xsl:template name="session_component_java.content.3">
...
</xsl:template> <!-- end of template session_component_java.content.3 -->



<!--
-->
<xsl:template name="session_component_java.content.4">
   <xsl:param name="_node"/>
   <xsl:param name="_readonlyId"/>
   <xsl:param name="_readonlyEndId"/>
   <xsl:param name="_paramName"/>
...
</xsl:template> <!-- end of template session_component_java.content.4 -->



<!--
-->
<xsl:template name="session_component_java.content.5">
...
</xsl:template> <!-- end of template session_component_java.content.5 -->



<!--
-->
<xsl:template name="session_component_java.content.6">
...
</xsl:template> <!-- end of template session_component_java.content.6 -->



<!--
-->
<xsl:template name="session_component_java.content.7">
...
</xsl:template> <!-- end of template session_component_java.content.7 -->



<!--
-->
<xsl:template name="session_component_java.content.8">
   <xsl:param name="_node"/>
   <xsl:param name="_readonlyId"/>
   <xsl:param name="_readonlyEndId"/>
   <xsl:param name="_paramName"/>
...
</xsl:template> <!-- end of template session_component_java.content.8 -->



<!--
-->
<xsl:template name="session_component_java.content.9">
...
</xsl:template> <!-- end of template session_component_java.content.9 -->



<!--
-->
<xsl:template name="session_component_java.content.10">
   <xsl:param name="_facetName"/>
...
</xsl:template> <!-- end of template session_component_java.content.10 -->



<!--
-->
<xsl:template name="session_component_java.content.11">
   <xsl:param name="_facetTypeName"/>
   <xsl:param name="_facetName"/>
...
</xsl:template> <!-- end of template session_component_java.content.11 -->



<!--
-->
<xsl:template name="session_component_java.content.12">
   <xsl:param name="_facetTypeName"/>
   <xsl:param name="_facetName"/>
...
</xsl:template> <!-- end of template session_component_java.content.12 -->



<!--
-->
<xsl:template name="session_component_java.content.13">
...
</xsl:template> <!-- end of template session_component_java.content.13 -->



<!--
-->
<xsl:template name="session_component_java.content.14">
   <xsl:param name="_receptacleName"/>
...
</xsl:template> <!-- end of template session_component_java.content.14 -->



<!--
-->
<xsl:template name="session_component_java.content.15">
...
</xsl:template> <!-- end of template session_component_java.content.15 -->



<!--
-->
<xsl:template name="session_component_java.content.16">
...
</xsl:template> <!-- end of template session_component_java.content.16 -->



<!--
-->
<xsl:template name="session_component_java.content.17">
   <xsl:param name="_publisherName"/>
...
</xsl:template> <!-- end of template session_component_java.content.17 -->



<!--
-->
<xsl:template name="session_component_java.content.18">
   <xsl:param name="_emitterName"/>
   
   <xsl:variable name="uppercaseEmitterName" select="translate($_emitterName, $lcase, $ucase)"/>

   declare_emitter(<xsl:value-of select="concat('EMITTER_', $uppercaseEmitterName,'_NAME, EMITTER_', $uppercaseEmitterName,'_REP_ID')"/>);
</xsl:template> <!-- end of template session_component_java.content.18 -->



<!--
-->
<xsl:template name="session_component_java.content.19">
   <xsl:param name="_consumerTypeName"/>
   <xsl:param name="_consumerName"/>
...
</xsl:template> <!-- end of template session_component_java.content.19 -->



<!--
-->
<xsl:template name="session_component_java.content.20">
   <xsl:param name="_consumerName"/>
   <xsl:param name="_componentName"/>
...
</xsl:template> <!-- end of template session_component_java.content.20 -->



<!--
-->
<xsl:template name="session_component_java.content.21">
   <xsl:param name="_consumerName"/>
...
</xsl:template> <!-- end of template session_component_java.content.21 -->



<!--
-->
<xsl:template name="session_component_java.content.22">
   <xsl:param name="_consumerTypeName"/>
   <xsl:param name="_consumerName"/>
...
</xsl:template> <!-- end of template session_component_java.content.22 -->
