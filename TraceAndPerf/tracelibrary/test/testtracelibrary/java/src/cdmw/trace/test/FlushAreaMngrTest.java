    ...
    public void doTests() {
        ...
        try {
            traceProducer = cdmw.trace.FlushAreaMngr.init(
                     ...
                     flushingTime,
                     2,                // 2 FlushArea
                     20 + headerSize   // Each FlushArea has 20 octets
                    );
        ...
        traceProducer.deactivate_level (com.thalesgroup.CdmwTrace.ALL_DOMAINS.value,
                                       com.thalesgroup.CdmwTrace.ALL_VALUES.value);
        traceProducer.activate_level ("domain1", (short) 1);
        ...
        traceProducer.activate_level("foo", (short) 2);
        traceProducer.activate_level("foo", (short) 5);
        check (cdmw.trace.FlushAreaMngr.isToBeTraced("foo", (short) 2) == true);
        check (cdmw.trace.FlushAreaMngr.isToBeTraced("foo", (short) 5) == true);
        
        traceProducer.deactivate_level ("foo", (short) 2);
        check (cdmw.trace.FlushAreaMngr.isToBeTraced("foo", (short) 2) == false);
        
        traceProducer.activate_level ("bar", (short) 5);
        check (cdmw.trace.FlushAreaMngr.isToBeTraced("bar", (short) 5) == true);
        
        traceProducer.activate_level ("bar", (short) 4);
        check (cdmw.trace.FlushAreaMngr.isToBeTraced("bar", (short) 4) == true);
        
        traceProducer.deactivate_level ("bar", (short) 5);
        check (cdmw.trace.FlushAreaMngr.isToBeTraced("bar", (short) 5) == false);
