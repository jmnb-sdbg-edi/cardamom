...
usage()
{
    ...
    echo "             Repository launched at the specified port"
    echo "             Default is $REPPORT"
    echo "    --repository-name name "
    echo "             Repository launched with the specified corbaloc name"
    echo "             Default is $REPNAME"
    echo "Description:"
    echo "      This program starts the Trace Administration Console."
}
...
REPOSITORY_URL=corbaloc::localhost:$REPPORT/$REPNAME
