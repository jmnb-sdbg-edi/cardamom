...
#ifndef INCL_VALIDATION_USER_RESOURCE_SERVANT_PROVIDER_HPP
#define INCL_VALIDATION_USER_RESOURCE_SERVANT_PROVIDER_HPP

#include "lifecycleserver2/ResourceServantProvider.hpp"
...
*
*/
class UserResourceServantProvider : public Cdmw::Resources::ResourceServantProvider
{
...
template <>
ServantProviderBase*
ServantProviderAllocator<Cdmw::Validation::UserResourceServantProvider>::allocate
                    (CORBA::ORB_ptr                  orb,
    ...
    throw(std::bad_alloc,
      CORBA::SystemException)
{
    return new Cdmw::Validation::UserResourceServantProvider(orb, adapter, deactivator);
}
...
template <>
void 
ServantProviderAllocator<Cdmw::Validation::UserResourceServantProvider>::dispose(ServantProviderBase * provider) 
    throw () 
{ 
...
typedef Cdmw::LifeCycle::ServantProviderAllocator<Cdmw::Validation::UserResourceServantProvider> USPAllocator;

};

}; // End namespace Cdmw
#endif // INCL_VALIDATION_USER_RESOURCE_SERVANT_PROVIDER_HPP
