...
/**
 * Multithread strategies supporting ThreadPerRequest policy.
 *
 */
public class ThreadPerRequestPolicy extends MultiThreadPolicy {
    ...
    public void print(java.io.PrintWriter out) {
        out.println(POAThreadingPolicy.THREAD_PER_REQUEST_DESIGNATION);
    }
