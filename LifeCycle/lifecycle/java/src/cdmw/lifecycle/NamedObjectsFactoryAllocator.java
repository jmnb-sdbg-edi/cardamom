...
/**
 * Generic class for CDMW named objects factories allocators.
 * Users may use explicit instantiation to change behaviour of
 * default allocation and disposal of factories.
 *
 */
public class NamedObjectsFactoryAllocator
    implements NamedObjectsFactoryAllocatorBase {
     ...
     */        
    public NamedObjectsFactoryAllocator(String factoryClassName) {
               ...
               InternalErrorException
    {
        ...
        try {
            ...
            Class[] parameterTypes = {
                ...
                Class.forName(
                    "com.thalesgroup.CdmwNamingAndRepository.NameDomain"),
