...
<!--
   ...
   @param none
-->
<xsl:template name="session_factory_allocator_hpp">
   <!--
      ...
      <xsl:if test="$_index &lt;= count($nodes)">
         ...
         <xsl:document method="text" href="{$filename}">
            ...
            <!--
               Insert the content.
            -->
            <xsl:call-template name="session_factory_allocator_hpp.content">
         ...
         -->
         <xsl:call-template name="session_factory_allocator_hpp">
...
-->
<xsl:template name="session_factory_allocator_hpp.content">
