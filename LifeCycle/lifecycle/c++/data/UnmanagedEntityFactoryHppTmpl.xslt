...
<!--
   ...
   @param none
-->
<xsl:template name="unmanaged_entity_factory_hpp">
   <!--
      ...
      <xsl:if test="$_index &lt;= count($nodes)">
         ...
         <xsl:document method="text" href="{$filename}">
            ...
            <!--
               Insert the content.
            -->
            <xsl:call-template name="unmanaged_entity_factory_hpp.content">
         ...
         -->
         <xsl:call-template name="unmanaged_entity_factory_hpp">
            <xsl:with-param name="_index" select="$_index + 1"/>
         </xsl:call-template>
      </xsl:if>
   </xsl:if>
</xsl:template> <!-- end of template unmanaged_entity_factory_hpp -->
...
-->
<xsl:template name="unmanaged_entity_factory_hpp.content">
      ...
      public virtual Cdmw::OrbSupport::RefCountServantBase
   {
      public:
         ...
         <xsl:call-template name="findAllFactoryOperations">
            ...
            <xsl:with-param name="_template" select="'unmanaged_entity_factory_hpp.content.1'"/>
...
</xsl:template> <!-- end of template unmanaged_entity_factory_hpp.content -->



<!--
-->
<xsl:template name="unmanaged_entity_factory_hpp.content.1">
