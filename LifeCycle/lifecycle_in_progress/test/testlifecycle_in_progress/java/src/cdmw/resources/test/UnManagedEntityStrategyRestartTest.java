...
public class UnManagedEntityStrategyRestartTest extends Testable {

    private String args;

    public UnManagedEntityStrategyRestartTest(String args, java.io.PrintStream out) {
        this.name = "UnManagedEntityStrategyRestartTest";
        this.out = out;
        this.args = args;
    }
    ...
    public void doTests() {
        ...
        try {
            ...
            String factoryName = TestData.get_UNMANAGED_ENTITY_FACTORY_NAME();
            String appl1Key = TestData.get_UNMANAGED_ENTITY_APPLICATION_I_KEY();
