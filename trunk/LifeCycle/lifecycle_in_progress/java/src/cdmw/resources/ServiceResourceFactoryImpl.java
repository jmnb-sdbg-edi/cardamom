 ...
 *
 */
public class ServiceResourceFactoryImpl extends AnonymousResourceFactoryPOA {
    ...
    public class TheServantLocator
        ...
        public org.omg.PortableServer.Servant preinvoke(
            ...
            System.out.println("\t[SERVICE]===> Pre-invoking " + s);
        ...
        public void postinvoke(
            ...
            // TODO: Begin for test only
            String s = new String(oid);
            System.out.println("\t[SERVICE]===> Post-invoking " + s);
    ...
    public ServiceResourceFactoryImpl(
        ...
        try {
            ...
            //
            cdmw.resources.UASPAllocator allocator =
                new cdmw.resources.UASPAllocator();
            ...
            try {
                ...
                // Shouldn't happen since cdmw.resources.UASPAllocator.allocate()
            ...
            //
            objectsPOA.set_servant_manager(new TheServantLocator(servantProvider));
    ...
    public Device create_device(String label) throws InvalidLocation {
        ...
        // Operation may throw user exceptions that will re-thrown to caller
        byte[] oid = servantProvider.createDevice(label);
        // [II] Create its object reference
        org.omg.CORBA.Object obj =
            ObjectUtil.createObjectReference(objectsPOA, oid, servantProvider);
