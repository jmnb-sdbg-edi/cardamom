...
#include <ccm_lb/CCM_ClientHome_impl.hpp>
...
extern "C" {
    ...
    create_CCM_ClientHome()
    {
        return new CcmLbTest::CCM_ClientHome_impl();
    };
};  // End extern C
...
//
CcmLbTest::CCM_ClientHome_impl::CCM_ClientHome_impl()
{
}
...
CcmLbTest::CCM_ClientHome_impl::create()
