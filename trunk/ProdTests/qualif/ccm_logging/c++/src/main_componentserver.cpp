...
main(int argc, char* argv[])
{
    ...
    try {
        ...
        Logger* logger = Logger::Get_Logger("QUALIF_CCM_LOGGING");

        CDMW_INFO(logger, "main component server of "
                          << applicationName << "/" << processName);

        // wait for CORBA messages.
        orb->run();
