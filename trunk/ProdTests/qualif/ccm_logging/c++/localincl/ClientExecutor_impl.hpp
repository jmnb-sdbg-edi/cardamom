...
#ifndef _CDMW_PIQ_CCM_LOGGING_CLIENTEXECUTOR_IMPL_HPP_
#define _CDMW_PIQ_CCM_LOGGING_CLIENTEXECUTOR_IMPL_HPP_
...
namespace Hello
{
              ...
              virtual public Cdmw::OrbSupport::RefCountLocalObject
    {
        ...
        private:
            ...
            void
            operator=(const ClientExecutor_impl&);
...
#endif // _CDMW_PIQ_CCM_LOGGING_CLIENTEXECUTOR_IMPL_HPP_
