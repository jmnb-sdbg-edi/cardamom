...
#ifndef INCL_GET_TIME_MANAGED_PROCESS_BEHAVIOUR2_HPP 
#define INCL_GET_TIME_MANAGED_PROCESS_BEHAVIOUR2_HPP
...
public:
    GetTimeManagedProcessBehaviour(CORBA::ORB_ptr, std::string hostname);
