...
#include <ccm_ft_datastore/User_ccm_ft.skel.hpp>
...
public:
    ...
    //
    virtual ::CcmFtTest::CCM_HostInfo_ptr get_clientHostInfo ()
        throw (CORBA::SystemException);
    
    virtual char* get_hostname()
        throw (CORBA::SystemException);
    
    virtual CORBA::Long get_data()
        throw (CORBA::SystemException);
    ...
    //
    virtual void push_hostnameResults (CcmFtTest::HostnameResult * event)
        throw (CORBA::SystemException);
...
private:
    ...
    void test_connections(const char* expectedHostname, long expectedData);
