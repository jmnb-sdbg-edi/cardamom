...
echo "cdmw_platform_supervision_starter --CdmwXMLFile=CdmwPlatformMngtSystemStartHost1Sys2.xml --validate $*"
cdmw_platform_supervision_starter --CdmwXMLFile=CdmwPlatformMngtSystemStartHost1Sys2.xml --validate $*
else
