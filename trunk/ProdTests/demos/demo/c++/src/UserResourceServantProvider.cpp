...
#include "UserResourceServantProvider.hpp"
#include "Device_impl.hpp"
#include "Application_impl.hpp"
#include "Foundation/common/Assert.hpp"
#include "MacroDefs.hpp"
    ...
    throw(CF::Device::InvalidLocation)
{
    try {
        ...
        ObjInfo info(DEV,new Resources::Device_impl(m_poa.in(),m_object_deactivator,CF::Device::IDLE,label));
        m_aom[key] = info;
    ...
    throw(CF::CreateApplicationError)
{
    try {
        ...
        ObjInfo info(APP,new Resources::Application_impl(m_object_deactivator,name));
        m_aom[key] = info;
