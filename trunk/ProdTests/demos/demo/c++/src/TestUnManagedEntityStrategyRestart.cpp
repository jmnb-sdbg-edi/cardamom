...
TestUnManagedEntityStrategyRestart::TestUnManagedEntityStrategyRestart(const std::string & args, 
                                                                       std::ostream &      os)
    throw()
    :Testable("Cdmw::LifeCycle::TestUnManagedEntityStrategyRestart",os),
     m_args(args)
{
    // does nothing
}
...
TestUnManagedEntityStrategyRestart::~TestUnManagedEntityStrategyRestart()
    throw()
{
    // does nothing
}
...
TestUnManagedEntityStrategyRestart::TestUnManagedEntityStrategyRestart(const TestUnManagedEntityStrategyRestart& rhs)
    throw()
...
TestUnManagedEntityStrategyRestart&
TestUnManagedEntityStrategyRestart::operator=(const TestUnManagedEntityStrategyRestart& rhs)
    throw()
{
    if (this != &rhs) {
        m_args    = rhs.m_args;
...
void TestUnManagedEntityStrategyRestart::do_tests()        
{
    //-------------------------------------------------
