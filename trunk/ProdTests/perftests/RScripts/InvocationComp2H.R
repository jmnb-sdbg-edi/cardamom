...
RRAM_CR_100<-scan("CR-100/REMOTE_RAMmonitor.mon")
RRAM_OW_0<-scan("OW-0/REMOTE_RAMmonitor.mon")
RRAM_OW_100<-scan("OW-100/REMOTE_RAMmonitor.mon")

###ACQUISIZIONE REMOTE_CPUmonitor.mon
RCPU_CR_0<-scan("CR-0/REMOTE_CPUmonitor.mon")
RCPU_CR_100<-scan("CR-100/REMOTE_CPUmonitor.mon")
RCPU_OW_0<-scan("OW-0/REMOTE_CPUmonitor.mon")
RCPU_OW_100<-scan("OW-100/REMOTE_CPUmonitor.mon")
...
rm(CD_lwd,color,dec_num,dev_dig,is2Host,l1,l2,nomi,png_height,png_width,rap,thresh,tipi,
	...
	RCPU_CR_0,RCPU_CR_100,RCPU_OW_0,RCPU_OW_100,
	RRAM_CR_0,RRAM_CR_100,RRAM_OW_0,RRAM_OW_100)
