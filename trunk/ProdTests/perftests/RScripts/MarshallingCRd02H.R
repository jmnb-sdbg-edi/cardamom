...
gr1<-"MarshCRd02HObS.png"		#NomeFile grafico Observation (*.png)
gr2<-"MarshCRd02HMean.png"		#NomeFile grafico Mean (*.png)
gr3<-"MarshCRd02HStd.png"		#NomeFile grafico StdDev (*.png)
gr4<-"MarshCRd02HBox.png"		#NomeFile grafico BoxPlot (*.png)
grRO<-"MarshCRd02HRAMObs.png"		#NomeFile grafico RAMObs (*.png)
grR<-"MarshCRd02HRAM.png"		#NomeFile grafico RAM (*.png)
grCO<-"MarshCRd02HCPUObs.png"		#NomeFile grafico CPUObs (*.png)
grC<-"MarshCRd02HCPU.png"		#NomeFile grafico CPU (*.png)
grRRO<-"MarshCRd02HRRAMObs.png"		#NomeFile grafico RRAMObs (*.png)
grRR<-"MarshCRd02HRRAM.png"		#NomeFile grafico RRAM (*.png)
grRCO<-"MarshCRd02HRCPUObs.png"		#NomeFile grafico RCPUObs (*.png)
grRC<-"MarshCRd02HRCPU.png"		#NomeFile grafico RCPU (*.png)
som<-"MarshallingCRd02H.htm"		#NomeFile Sommario (*.htm)
