...
Cdmw::clock::valid::ClientClockProcessBehaviour::ClientClockProcessBehaviour(
    CORBA::ORB_ptr orb,
...
Cdmw::clock::valid::ClientClockProcessBehaviour::~ClientClockProcessBehaviour() throw ()
{
}

    
CORBA::ULong
Cdmw::clock::valid::ClientClockProcessBehaviour::nb_steps()
...
void
Cdmw::clock::valid::ClientClockProcessBehaviour::on_initialise(
...
throw( CORBA::SystemException )
{
    ...
    try
    {
        ...
        m_group =
            CosClockService::Clock::_narrow( obj.in() );
    }
           ...
           CORBA::SystemException )
{
    ...
    m_client_thread = new ClientClockThread(m_group.in());
...
void
Cdmw::clock::valid::ClientClockProcessBehaviour::on_stop()
    throw( CORBA::SystemException )
{
