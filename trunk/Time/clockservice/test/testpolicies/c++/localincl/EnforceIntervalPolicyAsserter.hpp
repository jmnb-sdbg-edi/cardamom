...
/**
 * @brief Definition of class EnforceIntervalPolicyAsserter.
 * @author Marco Macellari <mmacellari@progesi.it>
 */

#ifndef ENFORCE_INTERVAL_POLICY_ASSERTER_HPP
#define ENFORCE_INTERVAL_POLICY_ASSERTER_HPP

#include "Asserter.hpp"

class EnforceIntervalPolicyAsserter : public Asserter
{
    public:

        /**
         * @brief Constructor of derived class for interval policy extended asserters.
    ...
    private:
         ...
         */
        typedef enum { init_point, rel_point, non_rel_point } point_kind_t;
        ...
        int           period_idx_;        // The value of every rel point such that virt_rel = time_origin_ + period_idx_ * period_.
};

#endif // ENFORCE_INTERVAL_POLICY_ASSERTER
