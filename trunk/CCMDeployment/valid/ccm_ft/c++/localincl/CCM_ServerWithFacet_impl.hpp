...
{
//
// IDL:thalesgroup.com/CcmFtTest/ServerModule/CCM_ServerWithFacet:1.0
//
    ...
    virtual public Cdmw::OrbSupport::RefCountLocalObject
{
    ...
    ::CcmFtTest::ServerModule::CCM_ServerWithFacet_Context_var m_session_context;
...
public:
    ...
    //
    virtual ::CcmFtTest::FacetModule::CCM_HostInfo_ptr get_serverHostInfo ()
        throw (CORBA::SystemException);
    ...
    ::CcmFtTest::ServerModule::CCM_ServerWithFacet_Context* get_context()
    {
        return ::CcmFtTest::ServerModule::CCM_ServerWithFacet_Context::_duplicate(m_session_context.in());
    }
