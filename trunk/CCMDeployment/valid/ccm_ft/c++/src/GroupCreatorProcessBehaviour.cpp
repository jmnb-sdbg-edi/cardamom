    ...
    throw( CORBA::SystemException )
{
    ...
    ::FT::ObjectGroup_var serverWithFacetGroup = 
        create_object_group("IDL:thalesgroup.com/Cdmw_CcmFtTest/ServerModule/ServerWithFacet:1.0", 3);
    ...
    ::FT::ObjectGroup_var serverWithEventsGroup = 
        create_object_group("IDL:thalesgroup.com/Cdmw_CcmFtTest/ServerModule/ServerWithEvents:1.0", 3);
