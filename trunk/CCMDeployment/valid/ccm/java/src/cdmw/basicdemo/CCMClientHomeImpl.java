...
//
public class CCMClientHomeImpl extends org.omg.CORBA.LocalObject
    implements com.acme.BasicDemo.CCM_ClientHome {

    public CCMClientHomeImpl() {}
    ...
    public org.omg.Components.EnterpriseComponent create() 
        ...
        return new CCMClientImpl();
    }
    
    /**
     * Create a new client home
     */
    public static org.omg.Components.HomeExecutorBase createCCMClientHome() {
        return new CCMClientHomeImpl();
    }
