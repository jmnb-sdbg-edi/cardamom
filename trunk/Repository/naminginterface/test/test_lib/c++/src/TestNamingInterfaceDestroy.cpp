...
namespace 
{
    ...
    bool 
    install_initial_bindings(Cdmw::NamingAndRepository::NamingInterface& n,
                             const std::string &                      base,
                             CORBA::Object_ptr                        obj)
    {    
        bool result = true;
        try {
            Cdmw::NamingAndRepository::NamingInterface ni = n.bind_new_context(base,true);
            ...
            ni.bind("naminginterface/c++/CVS/Entries",obj,true);
            ni.bind("naminginterface/c++/CVS/Entries.Log",obj,true);
            ni.bind("naminginterface/c++/CVS/Repository",obj,true);
            ni.bind("naminginterface/c++/CVS/Root",obj,true);
            ni.bind("naminginterface/c++/incl/CVS/Entries",obj,true);
            ni.bind("naminginterface/c++/incl/CVS/Repository",obj,true);
            ni.bind("naminginterface/c++/incl/CVS/Root",obj,true);
            ni.bind("naminginterface/c++/incl/NameParser.hpp",obj,true);
            ni.bind("naminginterface/c++/incl/NameParserContext.hpp",obj,true);
            ni.bind("naminginterface/c++/incl/NameParserFSM.hpp",obj,true);
            ni.bind("naminginterface/c++/src/CSC.mk",obj,true);
            ni.bind("naminginterface/c++/src/CVS/Entries",obj,true);
            ni.bind("naminginterface/c++/src/CVS/Repository",obj,true);
            ni.bind("naminginterface/c++/src/CVS/Root",obj,true);
            ni.bind("naminginterface/c++/src/InvalidName.cpp",obj,true);
            ni.bind("naminginterface/c++/src/main.cpp",obj,true);
            ni.bind("naminginterface/c++/src/NameParser.cpp",obj,true);
            ni.bind("naminginterface/c++/src/NameParserContext.cpp",obj,true);
            ni.bind("naminginterface/c++/src/NameParserFSM.cpp",obj,true);
            ni.bind("naminginterface/c++/src/NamingInterface.cpp",obj,true);
            Cdmw::NamingAndRepository::NamingInterface n 
                = ni.bind_new_context("naminginterface/ada.1",true);	
            n   = ni.bind_new_context("naminginterface/ada.2",true);	
        } catch (...) {
...
TestNamingInterfaceDestroy::TestNamingInterfaceDestroy (CosNaming::NamingContext_ptr nc,
						  TestObject_ptr               obj)
    throw()
    :Testable("Cdmw::NamingAndRepository::NamingInterface::destroy"),
...
//     }
	...
	TEST_INFO("Additional tests to NamingUtil<>::resolve_name() function");
	{
	    ...
	    input += "/naminginterface/dummy/ada.1";
	    try {
	...
	// 
	// Destroy naminginterface/ada.1 naming context
	//
	TEST_INFO("Destroy test.destroy/runtime/naminginterface/ada.1 (empty) naming context");
	{
	    std::string input(base);
	    input += "/naminginterface/ada.1";
	    try {
            NamingContext_var nc = Util::resolve_name(ni0,input);
	    ...
	    // Forcing destroy
	    input = base + "/naminginterface/ada.2";
	    try {
            NamingContext_var nc = Util::resolve_name(ni0,input);
		    NamingInterface n(nc.in());
