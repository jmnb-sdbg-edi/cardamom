...
case @config.Repository.java.orb@ in
	ORBacusJAVA)
	__ORB_CLASSPATH__=@config.ORBacusJAVA.classpath@
	;;

    JacORB)
        __ORB_CLASSPATH__=@config.JacORB.classpath@
...
exec java -Xbootclasspath/p:$__CLASSPATH__ cdmw.namingandrepository.test.RepositoryInterfaceTest $*
