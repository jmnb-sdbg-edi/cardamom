...
*/
class NameDomain_impl : virtual public POA_CdmwNamingAndRepository::ProxyFeatureNameDomain,
...
public:
    ...
    * <p>
    * Implements the
    * IDL:thalesgroup.com/CdmwNamingAndRepository/NameDomain/get_id:1.0
    * operation
    */
