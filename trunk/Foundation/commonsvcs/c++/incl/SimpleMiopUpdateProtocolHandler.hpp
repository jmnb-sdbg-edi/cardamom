...
#include "Foundation/commonsvcs/UpdateProtocolHandler.hpp"
#include "Foundation/commonsvcs/MiopTopicUpdateManager_impl.hpp"
...
public:
     ...
     * @param encoder the encoder that will provide an encapsulation
     *        for the topic to be updated
     */
    virtual
