 ...
 */
 public class BadParameterException extends Exception {
    ...
    /**
     * Constructor with the given parameter and its value
     *
    ...
    public BadParameterException(String parameterName,String parameterValue) {
      ...
      *
      * @param m message to be printed when exception raised
      */
     public BadParameterException(String m) {
         super(SAFE, "Invalid parameter: "+ m);
     }
