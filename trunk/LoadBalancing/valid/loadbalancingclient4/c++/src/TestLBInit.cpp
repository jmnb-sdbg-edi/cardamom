...
void TestLBInit::do_tests()
{
    ...
    try
    {
        ::PortableGroup::ObjectGroup_var object_group = m_group_manager->get_object_group_ref_from_gid(object_group_id);
  ...
  // add new member
    ...
    TEST_INFO("kill the agent of the APPL1");
    std::cout<<"Press any key and Enter"<<std::endl;
    std::cin >> dummy;
