...
std::string TestSupervision::TestNotificationReception::m_function;
CORBA::ORB_var TestSupervision::TestNotificationReception::m_orb;
...
protected:
    ...
    void run() throw()
    {
        ...
        */
        ...
        TestSupervision::TestNotificationReception::m_function = m_function;
        TestSupervision::TestNotificationReception::m_orb = CORBA::ORB::_duplicate(m_orb.in());
