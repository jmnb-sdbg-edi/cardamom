...
class TestPerfDaemon : public CppUnit::TestFixture
{
public:
    // constructor
...
public:
    ...
    static std::string                     m_nbtest;
    static std::string                     m_supervision;
    static std::string                     m_limittime;
    static std::string                     m_percentcase;
...
CPPUNIT_TEST_SUITE(TestPerfDaemon);
