...
static const char* common_messages[] =
{
    ...
    "Loss of event due to memory exhaustion",
    "Loss of event due to an unexpected exception",
    ...
    "Monitoring signaled",
    "Invalid Task identification \"%s\""
};


const char** CommonLogMessages::M_commonMessages = common_messages;
