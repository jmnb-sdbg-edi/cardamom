...
namespace PlatformMngt
{
    ...
    RWEntityContainer_impl::RWEntityContainer_impl(
            ...
            throw()
            : EntityContainer_impl(poa, pActualContainer,element_repository)
    {
    } 
    ...
    //
    CdmwPlatformMngt::Entity_ptr RWEntityContainer_impl::add_entity (
		           ...
		           CORBA::SystemException)
    {
	    CdmwPlatformMngt::Entity_var entityObject =
	                  getActualContainer()->addEntity(entity_def);
    ...
    void RWEntityContainer_impl::remove_entity(const char* entity_name)
             throw(CdmwPlatformMngt::EntityNotFound,
                   CORBA::SystemException)
    {
        getActualContainer()->removeEntity(entity_name);
    } 
