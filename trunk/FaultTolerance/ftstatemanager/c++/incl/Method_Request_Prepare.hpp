...
#ifndef _CDMW_FT_METHOD_REQUEST_PREPARE_HPP_
#define _CDMW_FT_METHOD_REQUEST_PREPARE_HPP_
...
class Method_Request_Prepare : public Cdmw::OsSupport::Runnable
{
public:
    Method_Request_Prepare 
    ...
    virtual ~Method_Request_Prepare (void) throw();
...
private:
    ...
    const CdmwFT::Transaction::StateChanges& m_change;
...
#endif // _CDMW_FT_METHOD_REQUEST_PREPARE_HPP_
