...
#ifndef INCL_CDMW_FT_FTSTATEMANAGER_DATASTORE_IMPL_HPP
#define INCL_CDMW_FT_FTSTATEMANAGER_DATASTORE_IMPL_HPP
...
class DataStore_impl:
            virtual public POA_CdmwFT::StateTransfer::DataStore,
            virtual public Cdmw::OrbSupport::RefCountServantBase 
{
public:
    DataStore_impl(PortableServer::POA_ptr poa, DataStoreBase& ds)
    ...
    ::CdmwFT::StateTransfer::RecordIterator_ptr get_record_iterator (
    ...
    {
        return m_datastore.get_record_iterator(from_location, coordinator,
                                               cohort);
    }

private:
    PortableServer::POA_var m_poa;
    DataStoreBase& m_datastore;
};
