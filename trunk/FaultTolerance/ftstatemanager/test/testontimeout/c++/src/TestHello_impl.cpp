...
char * HelloInterface1_impl::get_coordinator_location()
    throw(CORBA::SystemException)
{
   CORBA::String_var coordination_location(m_context->get_coordinator_location().c_str());
   return coordination_location._retn();
}
