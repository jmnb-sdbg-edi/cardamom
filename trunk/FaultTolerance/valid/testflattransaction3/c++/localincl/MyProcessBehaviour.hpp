...
public:
    ...
    * <p> The constructor.
    */ 
    MyProcessBehaviour  (CORBA::ORB_ptr orb, PortableServer::POA_ptr rootPOA, std::string the_host, Cdmw::TestORBInitializer* initializer)
        : m_hostname(the_host)
    {
	...
	*/
        ...
        throw( CORBA::SystemException)
    {
        ...
        Cdmw::HelloInterface_impl * helloInterface_impl
            = new ::Cdmw::HelloInterface_impl (m_orb.in(), m_rootPOA.in(), m_name.c_str(), m_initializer);
