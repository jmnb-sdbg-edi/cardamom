...
{    
    ...
    try 
    {
        ...
        // =========================================================
        CdmwNamingAndRepository::NameDomain_var helloDomainDenver =
        ...
        CdmwNamingAndRepository::NameDomain::RegistrationId_var regIdMike = 
                                    helloDomainDenver->new_name ("HelloInterface");
        // register the object
        helloDomainDenver->register_object (regIdMike, helloInterfaceMike.in());
        ...
        // ===================================================
        HelloModule::HelloInterface_var helloInterfaceBob;
        
        {
            Cdmw::Tutorial::HelloInterface_impl* pHelloInterfaceServant = 
                            new Cdmw::Tutorial::HelloInterface_impl("Bob");
		    ...
		    helloInterfaceBob = pHelloInterfaceServant->_this();
	    }
        ...
        // ===================================================
        HelloModule::HelloInterface_var helloInterfacePeter;
        
        {
            Cdmw::Tutorial::HelloInterface_impl* pHelloInterfaceServant = 
                            new Cdmw::Tutorial::HelloInterface_impl("Peter");
		    ...
		    helloInterfacePeter = pHelloInterfaceServant->_this();
	    }
        ...
        // ===================================================
        HelloModule::HelloInterface_var helloInterfaceJack;
        
        {
            Cdmw::Tutorial::HelloInterface_impl* pHelloInterfaceServant = 
                            new Cdmw::Tutorial::HelloInterface_impl("Jack");
		    ...
		    helloInterfaceJack = pHelloInterfaceServant->_this();
	    }
        ...
        // =========================================================
        CdmwNamingAndRepository::NameDomain_var helloDomainDallas =
            repository->resolve_name_domain ("TUTORIAL/HELLO/US/DALLAS");
             
             
        // ==========================================================
        // Register the HelloInterface objects in the DALLAS name domain
        // ==========================================================
        // reserve the name "HelloInterface" in the domain
        CdmwNamingAndRepository::NameDomain::RegistrationId_var regIdBob = 
                                    helloDomainDallas->new_name ("HelloInterfaceBob");
        // register the Bob object
        helloDomainDallas->register_object (regIdBob, helloInterfaceBob.in());
        
        
        // reserve the name "HelloInterface2" in the domain
        CdmwNamingAndRepository::NameDomain::RegistrationId_var regIdPeter = 
                                    helloDomainDallas->new_name ("HelloInterfacePeter");
        // register the Peter object
        helloDomainDallas->register_object (regIdPeter, helloInterfacePeter.in());
        
        // register the Jack object
        helloDomainDallas->register_new_object (
                     "HelloInterfaceJack", helloInterfaceJack.in());
