...
#ifndef INCL_DEMOLB_THREAD_HPP
#define INCL_DEMOLB_THREAD_HPP
...
class DemoLBThread : public Cdmw::OsSupport::Thread
{
...
protected:
    ...
    void run() throw()
    {
        ...
        Cdmw::LB::DemoLB demo(
            ...
            "DemoLB", m_host_name1, m_host_name2, m_host_name3);
