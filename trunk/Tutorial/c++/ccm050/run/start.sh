...
then
    ...
    $TERM -ls -sb -sl 1000 -e $CDMW_HOME/bin/cdmw_platform_supervision --CdmwLocalisationService=21871 --FaultManagerRegistration=corbaloc::localhost:4565/fault_manager --RequestDurationTime=20000000 --creation-timeout=20000&
    SUPERVISION_PID=$!
else
