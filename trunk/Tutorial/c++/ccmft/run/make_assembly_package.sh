...
PACK_TMP_DIR=/tmp/_CcmFt_Pack_tmp
...
cp $PARENT_DIR/data/ValidCcmFt.cad $PACK_TMP_DIR/meta-inf
...
# copy idl file
echo idl...
cp $PARENT_DIR/idl/ccm_ft.idl $PACK_TMP_DIR

# make links for libraries
ln -s $PARENT_DIR/$HOST_TYPE/libcdmwValidCcmFtServer.so $PACK_TMP_DIR/libcdmwValidCcmFtServer.so
ln -s $PARENT_DIR/$HOST_TYPE/libcdmwValidCcmFtClient.so $PACK_TMP_DIR/libcdmwValidCcmFtClient.so
