...
namespace 
{
    ...
    const char* TYPED_CHANNEL_NAME = "TypedEventChannel1";
...
{    
    ...
    Cdmw::Event::TypedEventChannelInterface* p_typedeventchannel;
                                               // typed event channel interface
    ...
    try 
    {
        ...
        std::cout << "Find a factory to create a typed channel" << std::endl;
        
        CORBA::Object_var obj2 = ni.resolve("EVENT/FACTORIES/DefaultTypedEventChannelFactory");
        
        CdmwEvent::TypedEventChannelFactory_var factory = 
            CdmwEvent::TypedEventChannelFactory::_narrow(obj2.in());
        ...
        // ========================================================
        // Create a new generic typed channel using factory
        // ========================================================
        std::cout << "Creating a new typed channel EventChannel" << std::endl;
        ...
        // ========================================================
        // Create the associated typed event channel interface
        // ========================================================
        p_typedeventchannel =
               new Cdmw::Event::TypedEventChannelInterface(channel.in());   
               
               
        // ========================================================
        // Create and connect a push consumer to the channel
        // ========================================================       
        std::cout << "Connect local consumer to TypedEventChannel1" << std::endl;
        
        Cdmw::Tutorial::Echo_impl* pcImpl = 
                       new Cdmw::Tutorial::Echo_impl(orb.in(), rootPOA.in());
    
        TypedEcho_var ref = pcImpl->_this();
        p_typedeventchannel->connect_typedPushConsumer(INTERFACE_REF, ref.in());
    ...
    // Event clean up
    // ===================================================
    p_typedeventchannel->destroy();
    delete p_typedeventchannel;
