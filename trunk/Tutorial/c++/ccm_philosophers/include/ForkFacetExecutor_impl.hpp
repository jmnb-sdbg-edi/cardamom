...
//
class ForkFacetExecutor_impl : virtual public CCM_Fork,
                               virtual public Cdmw::OrbSupport::RefCountLocalObject
{ 
    
  public:

    ForkFacetExecutor_impl();
    ~ForkFacetExecutor_impl();
  ...
  private:
    ...
    ForkFacetExecutor_impl(const ForkFacetExecutor_impl&);
    void operator=(const ForkFacetExecutor_impl&);
