...
ln -s $PARENT_DIR/$HOST_TYPE/libPhilosopher.so $PACK_TMP_DIR/libPhilosopher.so
ln -s $PARENT_DIR/$HOST_TYPE/libForkManager.so $PACK_TMP_DIR/libForkManager.so
ln -s $PARENT_DIR/$HOST_TYPE/libObserver.so $PACK_TMP_DIR/libObserver.so
ln -s $PARENT_DIR/$HOST_TYPE/libRegistrator.so $PACK_TMP_DIR/libRegistrator.so
