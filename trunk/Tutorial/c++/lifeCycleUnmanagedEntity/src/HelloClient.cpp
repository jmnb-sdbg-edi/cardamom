...
#include "HelloUnmanagedEntityFactory.stub.hpp"
...
{    
    ...
    try 
    {
	    ...
	    Cdmw::CdmwInit::ProcessControl_var process_ctrl =
              new Cdmw::Tutorial::HelloClientProcessControl(orb.in());
        ...
        CdmwLifeCycle::FactoryBase_var factory = factoryFinder->find_factory (
                        "Hello.Domain/Hello.Factories/HelloUnmanagedEntity.factory");
                        
                        
	    HelloUnmanagedEntityFactoryModule::HelloUnmanagedEntityFactory_var hello_factory = 
	             HelloUnmanagedEntityFactoryModule::HelloUnmanagedEntityFactory::_narrow(factory.in());

        // ======================================================
	    // get the HelloInterface proxy from the factory
	    // ======================================================
	    Hello::HelloInterface_var helloInterface = 
	             Hello::HelloInterface::_nil();
	             	    
	    helloInterface = hello_factory->create_HelloInterface ("HelloInterface_001");        
        ...
        std::cout << "Hello Client Started" << std::endl;
