...
#include <CCMDeployment/idllib/CdmwDeployment.skel.hpp>
...
namespace TestCardamomCCM
{
    ...
    private:
        ...
        // A map of <uuid,implementation>
        std::map<std::string,std::string>     m_implementations;
        // A map of <repid,location>
        std::map<std::string,std::string>     m_valuetypefactory_locations;
    };
