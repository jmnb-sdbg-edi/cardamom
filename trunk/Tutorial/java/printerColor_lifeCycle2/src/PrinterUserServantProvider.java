    ...
    extends cdmw.tutorial.PrinterServantProvider 
{
    ...
    */
        ...
        throws org.omg.CORBA.SystemException
    {
        ...
        String object_oid = "Printer_clr_" + device + "_" + oidCounter + "_" + timeval.getSeconds(); 
    ...
    */    
    ...
    public void releaseServant(byte[] oid,
                               ...
                               org.omg.PortableServer.Servant servant) 
    {
        System.out.println("<<PrinterUserServantProvider>> ColorPrinter servant reference removed.");
    }
