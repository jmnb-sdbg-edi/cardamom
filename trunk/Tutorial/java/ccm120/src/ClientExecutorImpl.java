    ...
    public void ccm_activate() {
        ...
        try {
           ...
           System.out.println("Get the display facet from server 1...");
            ...
            // ========================================================
            System.out.println("Get the NameService connection...");
            org.omg.CosNaming.NamingContext ncRoot = 
                sessionContext.get_connection_to_naming();
            ...
            org.omg.CORBA.Object objref1 = niRoot.resolve ("MyNaming/Tutorial/HelloServer1");
            ...
            org.omg.CORBA.Object objref2 = niRoot.resolve ("MyNaming/Tutorial/HelloServer2");
            ...
            org.omg.CORBA.Object objref3 = niRoot.resolve ("MyNaming/Tutorial/HelloClient");
