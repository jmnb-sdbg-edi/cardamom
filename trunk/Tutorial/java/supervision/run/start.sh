...
# 3) Start Platform Management Supervision
...
#$TERM -ls -sb -sl 500 -e 
$CDMW_HOME/bin/cdmw_platform_supervision_observer --register --system-corbaloc=corbaloc::localhost:21880/CdmwPlatformMngtSupervision --observer-name=observer &
