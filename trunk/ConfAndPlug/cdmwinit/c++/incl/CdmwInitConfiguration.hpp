...
#ifndef INCL_CDMWINIT_CDMWINITCONFIGURATION_HPP 
#define INCL_CDMWINIT_CDMWINITCONFIGURATION_HPP 
...
//            throw(ConfigurationException, InternalErrorException);
        ...
        */ 
        std::string 
        // getFactoryAttributeValue(const std::string& factoryType, 
        ...
        */ 
        std::string 
        // getFactoryMultithreadAttribute(const std::string& factoryType,
...
#endif // INCL_CDMWINIT_CDMWINITCONFIGURATION_HPP
