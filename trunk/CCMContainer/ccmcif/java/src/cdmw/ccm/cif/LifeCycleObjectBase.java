...
/**
 * A base implementation to a CosLifeCycle::LifeCycleObject. It is
 ...
 *
 */
public class LifeCycleObjectBase
    ...
    /**
     * true if remove operation already called
     */
     ...
     */
    public LifeCycleObjectBase(org.omg.Components.CCM2Context ctx) {
        this.context = ctx;
    }
    ...
    //
    /**
     * This makes a copy of the object. The copy is located in the scope of the
     * factory finder passed as the first parameter. It returns returns an 
     * object reference to the new object initialised from the existing object.
     ...
     * @param the_criteria Allows for a number of optional parameters 
     * to be passed (to the factory used in creating the new object)
     *
     * @return Object reference of the copy of the object
     *
     * @exception CosLifeCycle::NoFactory The target cannot find 
     * an appropriate factory to create a copy
     * @exception CosLifeCycle::NotCopyable The implementation refuses 
     * to copy itself
     * @exception CosLifeCycle::InvalidCriteria The target does not understand 
     * the criteria
     * @exception CosLifeCycle::CannotMeetCriteria The target understands 
     * the criteria but cannot satisfy the criteria
     */
    ...
    //
    /**
     * This moves the object to the scope of the factory finder passed as the
     ...
     * @param the_criteria Allows for a number of optional parameters 
     * to be passed (to the factory used in migrating the new object)
     *
     * @return The object reference of the new object
     *
     * @exception CosLifeCycle::NoFactory The target cannot find 
     * an appropriate factory to support migration of the object
     * @exception CosLifeCycle::NotMovable The implementation refuses 
     * to move itself
     * @exception CosLifeCycle::InvalidCriteria The target does not understand 
     * the criteria
     * @exception CosLifeCycle::CannotMeetCriteria The target understands 
     ...
     * raise a CORBA::OBJECT_NOT_EXIST system exception.
     *
     * @exception CosLifeCycle::NotRemovable An implementation that refuses 
     * to remove itself should raise this exception
     */
