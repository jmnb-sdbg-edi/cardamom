...
#ifndef INCL_CCM_CIF_PUBLISHERDESCRIPTION_IMPL_HPP
#define INCL_CCM_CIF_PUBLISHERDESCRIPTION_IMPL_HPP
...
class PublisherDescriptionFactory : virtual public CORBA::ValueFactoryBase
{
    virtual CORBA::ValueBase* create_for_unmarshal();

public:
    PublisherDescriptionFactory();
    virtual ~PublisherDescriptionFactory();
};
...
#endif // INCL_CCM_CIF_PUBLISHERDESCRIPTION_IMPL_HPP
