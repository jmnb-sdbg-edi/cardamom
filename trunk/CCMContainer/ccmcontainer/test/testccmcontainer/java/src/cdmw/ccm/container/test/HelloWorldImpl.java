...
public class HelloWorldImpl
    ...
    //
    public void say_hello(com.thalesgroup.HelloModule.Message msg) {
        System.out.println(
            "Hello world :-) message is '"  + msg.the_message + "'");
    }

    //
    // IDL:thalesgroup.com/HelloModule/Hello/log_message:1.0
    //
    public void log_message(com.thalesgroup.HelloModule.TraceMessage msg) {
        System.out.println("Hello world :-) Trace message is '"
            + msg.the_message + "' level is " + msg.the_level);
    }
...
System.out.println(" **** deactivated servant ");
