...
#ifndef INCL_DOCUMENTDESCRIPTION_IMPL_HPP
#define INCL_DOCUMENTDESCRIPTION_IMPL_HPP
...
namespace Cdmw
{
    ...
    */
    ...
    namespace XMLUtils
    {
        ...
        class DocumentDescription_impl : public virtual OBV_CdmwXML::DocumentDescription,
                    public virtual CORBA::DefaultValueRefCountBase
        {

            protected:

                DocumentDescription_impl();
                DocumentDescription_impl(CdmwXML::NodeType type,
                                         CdmwXML::Node_ptr reference,
                                         const CdmwXML::DOMString& doctype);

                friend class DocumentDescriptionFactory_impl;
            ...
            public:
                ...
                //
                virtual CdmwXML::DOMString* doctype();
