...
#ifndef INCL_CDATASECTIONDESCRIPTION_IMPL_HPP
#define INCL_CDATASECTIONDESCRIPTION_IMPL_HPP
...
namespace Cdmw
{
    ...
    */
    ...
    namespace XMLUtils
    {
        ...
        class CDATASectionDescription_impl : public virtual OBV_CdmwXML::CDATASectionDescription,
                    public virtual CORBA::DefaultValueRefCountBase
        {

            protected:

                CDATASectionDescription_impl();
                CDATASectionDescription_impl(CdmwXML::NodeType type,
                                             CdmwXML::Node_ptr reference,
                                             const CdmwXML::DOMString& data);

                friend class CDATASectionDescriptionFactory_impl;
