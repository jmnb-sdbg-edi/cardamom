    ...
    extends cdmw.testutils.Testable
{
    ...
    private static final String XML_FILE = "V-XMS-001-file.xml";
	...
	setNbOfRequestedTestOK(39);
        try {
            ...
            check("V-XMS-001-validation".equals(rootEltName));
            ...
            NodeDescription[] nodes1 = doc.select_nodes_from_root(
                XMLHelper.toShortArray("/V-XMS-001-validation/childElement"));
            ...
            NodeDescription[] nodes2 = doc.select_nodes_from_root(
                XMLHelper.toShortArray("/V-XMS-001-validation/childElement/@test_attr"));
            ...
            NodeDescription[] nodes3 = doc.select_nodes_from_root(
                XMLHelper.toShortArray("/V-XMS-001-validation/childElement/text()"));
            ...
            NodeDescription[] nodes4 = doc.select_nodes_from_root(
                XMLHelper.toShortArray("/V-XMS-001-validation/text()"));
        ...
        try {
            ...
            String xmlFile = userDir + "/V-XMS-001-data/" + XML_FILE;
            ...
            nodes = doc.select_nodes_from_root(
                XMLHelper.toShortArray("/V-XMS-001-validation/newElement/@newAttr"));
            ...
            // --- REQ 121 ---
            String modifiedFilename = userDir + "/V-XMS-001-data/modified.xml";
        ...
        try {
            // --- REQ 126 ---
            String newXmlFile = userDir + "/V-XMS-001-data/newDoc.xml";
