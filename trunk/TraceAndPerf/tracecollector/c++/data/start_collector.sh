...
$TRACECOLLECTOR_EXE --interactive --collector-name=collector_0 --traceFile-name=tracelog --CdmwLocalisationService=$COLPORT1 --CdmwProcessPort=$COLPORT2 --namingRepos-url=$REPOSITORY_URL
