...
$TRACECOLLECTOR_EXE --interactive --collector-name=collector_2 --traceFile-name=tracelog --CdmwLocalisationService=$COLPORT1 --CdmwProcessPort=$COLPORT2 --namingRepos-url=$REPOSITORY_URL --traceProducer-path amidala/trace/trace/TRACE/TraceProducer
