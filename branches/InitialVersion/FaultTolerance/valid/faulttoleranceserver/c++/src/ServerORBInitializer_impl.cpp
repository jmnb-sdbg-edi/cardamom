...
//
void
ServerORBInitializer_impl::pre_init(PortableInterceptor::ORBInitInfo_ptr info)
throw (CORBA::SystemException)
{
    std::cout<<"ServerORBInitializer_impl::pre_init"<<std::endl;
    //
    ...
    PortableInterceptor::ServerRequestInterceptor_var serverInterceptor 
        = new TestServerInterceptor_impl(info, slotId, "1");

    this->server_interceptor_ = serverInterceptor ;
...
//
void
ServerORBInitializer_impl::post_init(PortableInterceptor::ORBInitInfo_ptr info)
throw (CORBA::SystemException)
{
    std::cout<<"ServerORBInitializer_impl::post_init"<<std::endl;
}


PortableInterceptor::ServerRequestInterceptor_ptr
ServerORBInitializer_impl::server_interceptor (void)
{
  return
