...
#include "testftrequestlogging3/TestHello_impl.hpp"
#include <string>
#include <sstream>
#include <iostream>
#include <fstream>
...
public:
	...
	*/
        ...
        throw( CORBA::SystemException)
    {
        ...
        Cdmw::HelloInterface_impl * helloInterface1_impl = new Cdmw::HelloInterface_impl(m_orb.in(), m_rootPOA.in());
        CdmwRequestLogging::HelloInterface_var helloInterface1 =  helloInterface1_impl->_this();

        std::string full_name1 = process_name + "HelloInterface";
