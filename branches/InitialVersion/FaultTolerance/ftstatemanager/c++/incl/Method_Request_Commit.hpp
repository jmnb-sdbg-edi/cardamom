...
#ifndef _CDMW_FT_METHOD_REQUEST_COMMIT_HPP_
#define _CDMW_FT_METHOD_REQUEST_COMMIT_HPP_
...
class Method_Request_Commit : public Cdmw::OsSupport::Runnable
{
public:
    Method_Request_Commit (CdmwFT::Transaction::TPCCohort_ptr cohort,
                           Cdmw::FT::TransactionEngineCoordinatorBase* coordinator,
                           CdmwFT::Transaction::TransactionIdentification id,
                           const std::string & location);
    
    virtual ~Method_Request_Commit (void) throw();
...
#endif // _CDMW_FT_METHOD_REQUEST_COMMIT_HPP_
