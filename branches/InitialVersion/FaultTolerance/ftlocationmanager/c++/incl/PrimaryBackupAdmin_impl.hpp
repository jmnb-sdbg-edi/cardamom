...
#ifndef INCL_CDMW_FT_LOCATION_PRIMARY_BACKUP_ADMIN_IMPL_HPP
#define INCL_CDMW_FT_LOCATION_PRIMARY_BACKUP_ADMIN_IMPL_HPP
...
// forward declaration
class PrimaryBackupGroupRepository_impl;
class ActivationManager_impl;

//
// IDL:thalesgroup.com/CdmwFT/Location/PrimaryBackupAdmin:1.0
//
class PrimaryBackupAdmin_impl : virtual public POA_CdmwFT::Location::PrimaryBackupAdmin,
                                public MembersAdmin_impl
{

public:

    PrimaryBackupAdmin_impl(CORBA::ORB_ptr orb,
                            PortableServer::POA_ptr poa, 
                            const ::FT::Location& the_location,
                            PrimaryBackupGroupRepository_impl* group_repository,
                            bool is_ftmanager = false);
    ~PrimaryBackupAdmin_impl();
...
private:
    PrimaryBackupAdmin_impl();
    PrimaryBackupAdmin_impl(const PrimaryBackupAdmin_impl&);
    void operator=(const PrimaryBackupAdmin_impl&);
    ...
    // activation manager reference responsible to activate/deactivate member
    // when they are elected primary
    ActivationManager_impl* m_activation_manager;
...
#endif  // INCL_CDMW_FT_LOCATION_PRIMARY_BACKUP_ADMIN_IMPL_HPP
