    ...
    )
{
    ...
    PP_min_topic = dp->create_topic ("PP_min_topic", "pingpong::PP_min_msg", TOPIC_QOS_DEFAULT, NULL);
    ...
    PP_seq_topic = dp->create_topic ("PP_seq_topic", "pingpong::PP_seq_msg", TOPIC_QOS_DEFAULT, NULL);
    ...
    PP_string_topic = dp->create_topic ("PP_string_topic", "pingpong::PP_string_msg", TOPIC_QOS_DEFAULT, NULL);
    ...
    PP_fixed_topic = dp->create_topic ("PP_fixed_topic", "pingpong::PP_fixed_msg", TOPIC_QOS_DEFAULT, NULL);
    ...
    PP_array_topic = dp->create_topic ("PP_array_topic", "pingpong::PP_array_msg", TOPIC_QOS_DEFAULT, NULL);
    ...
    PP_quit_topic = dp->create_topic ("PP_quit_topic", "pingpong::PP_quit_msg", TOPIC_QOS_DEFAULT, NULL);
    ...
    while (!terminate) {
        ...
        result = w.wait (conditionList.out (), DURATION_INFINITY);
        ...
        for (i = 0; i < imax; i++) {
			...
			terminate = TRUE;
                ...
                cout << "PONG: unknown condition triggered: "<<  (*conditionList)[i] << endl;
            }
        }
    }
