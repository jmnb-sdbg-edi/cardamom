...
#ifndef INCL_DEMO_FT_HELLO_SERVANT_LOCATOR_HPP
#define INCL_DEMO_FT_HELLO_SERVANT_LOCATOR_HPP
...
// This ServantLocator is used to redefines the postinvoke operation, 
// and to call the LoggingMechanism.

class HelloServantLocator:
    ...
    public virtual Cdmw::OrbSupport::RefCountLocalObject
{
    ...
    private: 
        ...
        // ObjectId of the HelloInterface object
...
#endif // INCL_DEMO_FT_HELLO_SERVANT_LOCATOR_HPP
