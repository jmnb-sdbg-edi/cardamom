...
#include <CCM_Registrator_impl.hpp>
#include <iostream>
...
{
	 char * philosophers[] = {
	"Plato", "Socrates", "Descartes", "Pascal", "Aristotle", "Pythagoras", "Zeno",
	"Heraclitus", "Democritus", "Hegel", "Kant", "Protagoras"
      };
      ...
      char tmp[42];
      sprintf (tmp, "Philosopher # %lu", (unsigned long int) m_philosophers);
		m_philosophers++;
