...
namespace Marshalling
{
        ...
        throw(CORBA::SystemException)
    {
        ...
        /* Old code used when the non ccm server was registering perf_test/TestPing
           in domain naming
        ...
        */
        // Begin of new code that retrieve "TestPing" registered via CcmPerf.cad
        // in the naming interface (which is not domain naming..)
        std::cout << "CLIENT ### GET  DEFAULT_ROOT_CONTEXT ###" << std::endl;
        ...
        try {
            std::cout << "CLIENT ### RESOLVE  TestPing ###" << std::endl;
