...
then
    ...
    $TERM -ls -sb -sl 500 -e $CDMW_HOME/bin/cdmw_platform_supervision --CdmwLocalisationService=21871 --FaultManagerRegistration=corbaloc::localhost:4565/fault_manager --RequestDurationTime=20000000 --creation-timeout=20000&
    SUPERVISION_PID=$!
else
...
$echo "=============================================================="
$echo "Hit a key when ready to stop the Server.                      "
read FOO
$echo "=============================================================="
...
$CDMW_HOME/bin/cdmw_platform_admin --system-corbaloc=corbaloc::localhost:21871/CdmwPlatformMngtSupervision --proc-stop TutorialApplication TutorialServer


$echo "=============================================================="
$echo "Hit a key when ready to restart the Server.                   "
read FOO
$echo "=============================================================="
...
$CDMW_HOME/bin/cdmw_platform_admin --system-corbaloc=corbaloc::localhost:21871/CdmwPlatformMngtSupervision --proc-initialise TutorialApplication TutorialServer
sleep $INIT_TIMEOUT
$CDMW_HOME/bin/cdmw_platform_admin --system-corbaloc=corbaloc::localhost:21871/CdmwPlatformMngtSupervision --proc-run TutorialApplication TutorialServer
