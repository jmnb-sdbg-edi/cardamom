...
#include "HelloSessionFactory.stub.hpp"
...
{    
    ...
    try 
    {
        ...
        CdmwLifeCycle::FactoryBase_var factory = factoryFinder->find_factory (
                        "Hello.Domain/Hello.Factories/HelloSession.factory");
                        
                        
	    HelloSessionFactoryModule::HelloSessionFactory_var hello_factory = 
	             HelloSessionFactoryModule::HelloSessionFactory::_narrow(factory.in());
	    ...
	    helloInterface = hello_factory->create_HelloInterface ();        
