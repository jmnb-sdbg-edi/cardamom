...
string CmdUsage::M_cmdUsage =
    ...
    "  "PROC_SET_INFO" "PROC_SET_AUTOENDING" "PROC_SET_HOST"\n"
    "  "PROC_SET_LIFE_CYLE"\n"
    "\n"
...
CmdInfo _cmdInfoTab[] =
{
    ...
    { SYS_ADD_ENTITY,
        ...
        "\n"
        "Usage: ["LOG_FILE_OPTION"=log_file_name] ["CHECK_ONLY_OPTION"] ["SYSTEM_CORBALOC_OPTION"=corbaloc] \\ \n"
        "       "SYS_ADD_ENTITY" \"new_entity_name\"\n" },
    { SYS_REMOVE_ENTITY,
    ...
    { APP_REMOVE_PROCESS,
        ...
        "\n"
        "Usage: ["LOG_FILE_OPTION"=log_file_name] ["CHECK_ONLY_OPTION"] ["SYSTEM_CORBALOC_OPTION"=corbaloc] \\ \n"
        "       "APP_REMOVE_PROCESS" application_name process_name\n" },
    { APP_ADD_SERVICE,
    ...
    { APP_ADD_ENTITY,
        ...
        "\n"
        "Usage: ["LOG_FILE_OPTION"=log_file_name] ["CHECK_ONLY_OPTION"] ["SYSTEM_CORBALOC_OPTION"=corbaloc] \\ \n"
        "       "APP_ADD_ENTITY" application_name \"new_entity_name\"\n" },
    { APP_REMOVE_ENTITY,
    ...
    { PROC_SNAPSHOT,
        ...
        "\n"
        "Usage: ["LOG_FILE_OPTION"=log_file_name] ["CHECK_ONLY_OPTION"] ["SYSTEM_CORBALOC_OPTION"=corbaloc] \\ \n"
        "       "PROC_SNAPSHOT" application_name process_name\n" },
    { PROC_ADD_SERVICE,
        "Adds a service to a specified process.\n"
        "\n"
        "Usage: ["LOG_FILE_OPTION"=log_file_name] ["CHECK_ONLY_OPTION"] ["SYSTEM_CORBALOC_OPTION"=corbaloc] \\ \n"
        "       "PROC_ADD_SERVICE" application_name process_name \\ \n"
        "       \"service_file_name\"\n" },
    { PROC_REMOVE_SERVICE,
        "Removes a service from a specified process.\n"
        "\n"
        "Usage: ["LOG_FILE_OPTION"=log_file_name] ["CHECK_ONLY_OPTION"] ["SYSTEM_CORBALOC_OPTION"=corbaloc] \\ \n"
        "       "PROC_REMOVE_SERVICE" application_name process_name \\ \n"
        "       service_name\n" },
    { PROC_ADD_ENTITY,
        "Adds an entity to a specified process.\n"
        "\n"
        "Usage: ["LOG_FILE_OPTION"=log_file_name] ["CHECK_ONLY_OPTION"] ["SYSTEM_CORBALOC_OPTION"=corbaloc] \\ \n"
        "       "PROC_ADD_ENTITY" application_name process_name \\ \n"
        "       \"new_entity_name\"\n" },
    { PROC_REMOVE_ENTITY,
        "Removes an entity from a specified process.\n"
        "\n"
        "Usage: ["LOG_FILE_OPTION"=log_file_name] ["CHECK_ONLY_OPTION"] ["SYSTEM_CORBALOC_OPTION"=corbaloc] \\ \n"
        "       "PROC_REMOVE_ENTITY" application_name process_name \\ \n"
        "       entity_name\n" },
    { PROC_ADD_PROPERTY,
        "Adds a property to a specified process.\n"
        "\n"
        "Usage: ["LOG_FILE_OPTION"=log_file_name] ["CHECK_ONLY_OPTION"] ["SYSTEM_CORBALOC_OPTION"=corbaloc] \\ \n"
        "       "PROC_ADD_PROPERTY" application_name process_name \\ \n"
        "       \"new_property_name\"\n" },
    { PROC_REMOVE_PROPERTY,
        "Removes a property from a specified process.\n"
        "\n"
        "Usage: ["LOG_FILE_OPTION"=log_file_name] ["CHECK_ONLY_OPTION"] ["SYSTEM_CORBALOC_OPTION"=corbaloc] \\ \n"
        "       "PROC_REMOVE_PROPERTY" application_name process_name \\ \n"
        "       property_name\n" },
    { PROC_INITIALISE,
        "Starts the initialisation of a managed process.\n"
        "\n"
        "Usage: ["LOG_FILE_OPTION"=log_file_name] ["CHECK_ONLY_OPTION"] ["SYSTEM_CORBALOC_OPTION"=corbaloc] \\ \n"
        "       "PROC_INITIALISE" application_name process_name [state_retrieval startup_mode specified_state_id]\n"
        "\n"
        "The following parameters are optional. They are meaningful only to the\n"
        "application software.\n"
        "\n"
    ...
    { PROC_NEXT_STEP,
        ...
        "\n"
        "Usage: ["LOG_FILE_OPTION"=log_file_name] ["CHECK_ONLY_OPTION"] ["SYSTEM_CORBALOC_OPTION"=corbaloc] \\ \n"
        "       "PROC_NEXT_STEP" application_name process_name\n" },
    { PROC_RUN,
        "Requests a managed process to run.\n"
        "\n"
        "Usage: ["LOG_FILE_OPTION"=log_file_name] ["CHECK_ONLY_OPTION"] ["SYSTEM_CORBALOC_OPTION"=corbaloc] \\ \n"
        "       "PROC_RUN" application_name process_name\n" },
    { PROC_STOP,
        "Requests a process to stop properly if it is a managed process.\n"
        "\n"
        "Usage: ["LOG_FILE_OPTION"=log_file_name] ["CHECK_ONLY_OPTION"] ["SYSTEM_CORBALOC_OPTION"=corbaloc] \\ \n"
        "       "PROC_STOP" application_name process_name [EMERGENCY]\n"
        "\n"
        "EMERGENCY is specified if the system is required to stop with\n"
        "emergency otherwise it is required to stop properly according to\n"
        "the specified stop graph.\n" },
    { PROC_SET_INFO,
        ...
        "\n"
        "Usage: ["LOG_FILE_OPTION"=log_file_name] ["CHECK_ONLY_OPTION"] ["SYSTEM_CORBALOC_OPTION"=corbaloc] \\ \n"
        "       "PROC_SET_INFO" application_name process_name EXEC=\"executable_file\" PORT=process_port \\ \n"
        "       WDIR=\"working_directory\" ARGS=\"process_arguments\" \n" },
    { PROC_SET_AUTOENDING,
        "Requests a process to stop by itself.\n"
        "\n"
        "Usage: ["LOG_FILE_OPTION"=log_file_name] ["CHECK_ONLY_OPTION"] ["SYSTEM_CORBALOC_OPTION"=corbaloc] \\ \n"
        "       "PROC_SET_AUTOENDING" application_name process_name\n" },
    { PROC_SET_HOST,
        "Changes the host of execution of a process.\n"
        "\n"
        "Usage: ["LOG_FILE_OPTION"=log_file_name] ["CHECK_ONLY_OPTION"] ["SYSTEM_CORBALOC_OPTION"=corbaloc] \\ \n"
        "       "PROC_SET_HOST" application_name process_name host_name\n" },
    { PROC_SET_LIFE_CYLE,
        "Changes the life cycle definition of a process.\n"
        "\n"
        "Usage: ["LOG_FILE_OPTION"=log_file_name] ["CHECK_ONLY_OPTION"] ["SYSTEM_CORBALOC_OPTION"=corbaloc] \\ \n"
        "       "PROC_SET_LIFE_CYLE" application_name process_name life_cycle_file\n" },
