...
(Cdmw::clock::Ident                                id,
 ...
 ACE_Reactor*                                      reactor)
    : Cdmw::clock::FTController_impl::Controller_impl(clock, periodic, reactor),
      m_id(id),
    ...
    throw (CORBA::SystemException)
{
    ...
    data.timer_info.nextExpirationTime =
        period + with_offset + this->Controller_impl::clock_.current_time();
    data.timer_info.data = params;
    data.timer_info.status = RUNNING;
