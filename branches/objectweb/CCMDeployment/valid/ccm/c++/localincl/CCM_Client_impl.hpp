...
#include <ccm/UserBasicDemo.skel.hpp>

namespace BasicDemo
{

//
// IDL:thalesgroup.com/UserBasicDemo/CCM_Client:1.0
//
class CCM_Client_impl : virtual public ::UserBasicDemo::User_CCM_Client,
...
public:
    ...
    ~CCM_Client_impl();
    //
    // IDL:thalesgroup.com/UserBasicDemo/CCM_Client_Executor/name:1.0
    //
    virtual char* name()
        throw(CORBA::SystemException);
	 
    //
    // IDL:thalesgroup.com/UserBasicDemo/CCM_Client_Executor/event:1.0
    //
    virtual BasicDemo::Event2* event()
        throw(CORBA::SystemException);
    virtual void event(const BasicDemo::Event2& )
        throw(CORBA::SystemException);
