...
namespace Cdmw
{
    ...
    namespace OrbSupport
    {
        ...
        */
        ...
        void RefCountLocalObject::_add_ref()
        {
            CDMW_MUTEX_GUARD(m_count_mutex);
            ++m_ref_count;
        }

        void RefCountLocalObject::_remove_ref()
        {
            bool del = false;
            {
                CDMW_MUTEX_GUARD(m_count_mutex);
        ...
        CORBA::ULong RefCountLocalObject::_get_ref_count() const
        {
        ...
        CORBA::ULong RefCountLocalObject::_set_ref_count(CORBA::ULong count)
        {
            CDMW_MUTEX_GUARD(m_count_mutex);
