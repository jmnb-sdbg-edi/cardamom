...
public class BindContextTest extends Testable {
    ...
    private void testBindNewContext() {
        ...
        //     cdmw.test/runtime/namingandrepository/c++/test/idl
        ...
        // cdmw.test/runtime/namingandrepository/c++/test/idl
        input += "/runtime/namingandrepository/c++/test/idl";
        println("Creating cdmw.test/runtime/namingandrepository/c++/test/idl binding");
        try {
            NamingInterface ni = ni0.bindNewContext(input,false);
            fail();
        } catch (NotFound nf) {
    ...
    private void testBindContext() {
        ...
        //     cdmw.test/archive/namingandrepository/c++
        //        (link to cdmw.test/runtime/namingandrepository/c++)

        // Get a reference to the naming context bound to
        // cdmw.test/runtime/namingandrepository/c++
        NamingContext nc = null;
        try {
            // resolve has already been tested
            org.omg.CORBA.Object obj = ni0.resolve("cdmw.test/runtime/namingandrepository/c++");
        ...
        String input = "cdmw.test/archive/runtime/namingandrepository/c++";
        ...
        // Forcing creation
        println("Forcing bind of cdmw.test/archive/runtime/namingandrepository/c++");
        try {
        ...
        // Expecting NamingContext::NotFound exception
        //     ex.why == NamingContext::not_context
        input = "cdmw.test/archive/orbacus.mk/runtime/namingandrepository/c++";
        println("Attempt to bind " + input);
        try {
        ...
        //
        input = "cdmw.test/archive/runtime/namingandrepository/c++";
    ...
    private void testRebindContext() {
        ...
        //     cdmw.test/archive.2/namingandrepository/c++
        //        (link to cdmw.test/runtime/namingandrepository/c++)

        // Get a reference to the naming context bound to
        // cdmw.test/runtime/namingandrepository/c++
        NamingContext nc;
        String input = "cdmw.test/runtime/namingandrepository/c++";
        try {
            NameComponent[] name // This has already been tested
        ...
        // Expecting NamingContext::NotFound exception
        //     ex.why == NamingContext::not_context
        input = "cdmw.test/archive.2/runtime/namingandrepository/c++";
        ...
        // Expecting NamingContext::NotFound exception
        //     ex.why == NamingContext::not_context
        input = "cdmw.test/archive.2/orbacus.mk/runtime/namingandrepository/c++";
        println("Attempt to rebind " + input);
        try {
            ni0.rebindContext(input, nc, false);
            fail();
        ...
        // Forcing creation (exception NamingContext::NotFound expected)
        println("Forcing rebind of cdmw.test/archive/orbacus.mk/runtime/namingandrepository/c++");
        try {
            ni0.rebindContext(input, nc, true);
            fail();
        } catch (NotFound nf) {
    ...
    private void testNewContext() {
        ...
        // This test creates the following bindings in the naming service:
        //     cdmw.test/runtime/namingandrepository/c++/test/incl

        String input = "cdmw.test/runtime/namingandrepository/c++/test";
