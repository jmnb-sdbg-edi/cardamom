...
namespace CIF {
    ...
    CORBA::ValueBase*
        ReceptacleDescription_impl::_copy_value()
    {
        ReceptacleDescription_impl* result = new ReceptacleDescription_impl;
        result->name(name());
   ...
   /******************************/
    /*         Factory            */
    /******************************/
    ReceptacleDescriptionFactory::ReceptacleDescriptionFactory()
    {
    }
    ...
    CORBA::ValueBase *
        ReceptacleDescriptionFactory::create_for_unmarshal ()
    {
