...
#----------------------------------------------------------------------
#  This shell script launches the Performance Test  
#----------------------------------------------------------------------
usage()
{
...
PERFORMANCE_EXE=$CDMW_RUNTIME_ROOT/performancelibrary/c++/test/test3/prod/$ORB_CPP/$BINARY_TYPE/performance
###


REPOSITORY_URL=corbaloc::localhost:$REPPORT/SimRepository

$PERFORMANCE_EXE --url $REPOSITORY_URL
