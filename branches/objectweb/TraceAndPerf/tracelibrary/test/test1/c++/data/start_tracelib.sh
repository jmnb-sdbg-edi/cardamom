...
#----------------------------------------------------------------------
#  This shell script launches the Trace Library Test  
#----------------------------------------------------------------------
usage()
{
    ...
    echo "Description:"
    echo "      This program starts the Trace Library test."
}
...
TRACELIB_EXE=$CDMW_RUNTIME_ROOT/tracelibrary/c++/test/test1/prod/$ORB_CPP/$BINARY_TYPE/cdmw_test_trace
###

REPOSITORY_URL=corbaloc::localhost:$REPPORT/SimRepository

$TRACELIB_EXE --interactive --application-name=trace --namingRepos-url=$REPOSITORY_URL
