...
#ifndef INCL_RESOURCES_USER_ANONYMOUS_RESOURCE_SERVANT_PROVIDER_HPP
#define INCL_RESOURCES_USER_ANONYMOUS_RESOURCE_SERVANT_PROVIDER_HPP
...
*
*/
class UserAnonymousResourceServantProvider : public ResourceServantProvider
{
...
template <>
ServantProviderBase*
ServantProviderAllocator<Cdmw::Resources::UserAnonymousResourceServantProvider>::allocate
                    (CORBA::ORB_ptr                  orb,
    ...
    throw(std::bad_alloc,
          CORBA::SystemException)
{
    return new Cdmw::Resources::UserAnonymousResourceServantProvider(orb, adapter, deactivator);
}

typedef Cdmw::LifeCycle::ServantProviderAllocator<Cdmw::Resources::UserAnonymousResourceServantProvider> USPAllocator;

};

}; // End namespace Cdmw
#endif // INCL_RESOURCES_USER_ANONYMOUS_RESOURCE_SERVANT_PROVIDER_HPP
