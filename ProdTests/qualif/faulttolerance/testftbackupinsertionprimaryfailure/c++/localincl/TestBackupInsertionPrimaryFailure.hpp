...
class TestBackupInsertionPrimaryFailure : virtual public Cdmw::TestUtils::Testable
{
public:
    // constructor
    TestBackupInsertionPrimaryFailure(
        CORBA::ORB_ptr orb,
    ...
    // destructor
    virtual ~TestBackupInsertionPrimaryFailure();
