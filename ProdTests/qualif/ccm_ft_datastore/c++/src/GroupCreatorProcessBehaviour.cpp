...
#include <fstream>
#include <ccm_ft_datastore/GroupCreatorProcessBehaviour.hpp>
...
static const char* SERVERWITHEVENTS_GROUP_IORFILE = "ServerWithEvents.ior";
    ...
    throw( CORBA::SystemException )
{
    ...
    ::FT::ObjectGroup_var serverWithFacetGroup = 
      create_object_group("IDL:thalesgroup.com/Cdmw_CcmFtTest/ServerWithFacet:1.0", 3, true);
    ...
    std::cout << "      -> create group for ServerWithEvents" << std::endl;
    ::FT::ObjectGroup_var serverWithEventsGroup = 
      create_object_group("IDL:thalesgroup.com/Cdmw_CcmFtTest/ServerWithEvents:1.0", 3, false);
    std::cout << "      -> write it's IOR in " << SERVERWITHEVENTS_GROUP_IORFILE << std::endl;
    write_ior_file(serverWithEventsGroup.in(), SERVERWITHEVENTS_GROUP_IORFILE);
