...
#include "ccm_logging/ServerExecutor_impl.hpp"
...
namespace Hello
{
    ...
    ServerExecutor_impl::ServerExecutor_impl()
            : m_display(new DisplayFacetExecutor_impl),
              m_logger(Cdmw::Logging::Logger::Get_Logger("CCM_Server",
                                                         "QUALIF_CCM_LOGGING"))
    {
        // m_display = new DisplayFacetExecutor_impl;
    }
    ...
    ServerExecutor_impl::~ServerExecutor_impl()
    {
        CDMW_INFO(m_logger, "ServerExecutor_impl::~ServerExecutor_impl() called.");
     ...
     */
    CCM_Display_ptr
    ServerExecutor_impl::get_server_facet()
        throw(CORBA::SystemException)
    {
        CDMW_INFO(m_logger, "ServerExecutor_impl::get_server_facet() called.");
