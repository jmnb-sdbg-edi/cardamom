...
#ifndef _CDMW_PIQ_CCM_LOGGING_DISPLAYFACETEXECUTOR_IMPL_HPP_
#define _CDMW_PIQ_CCM_LOGGING_DISPLAYFACETEXECUTOR_IMPL_HPP_
...
namespace Hello
{
     ...
     */
    class DisplayFacetExecutor_impl
            : virtual public CCM_Display,
              virtual public Cdmw::OrbSupport::RefCountLocalObject
    {
        ...
        private:
            ...
            void
            operator=(const DisplayFacetExecutor_impl&);
...
#endif // _CDMW_PIQ_CCM_LOGGING_DISPLAYFACETEXECUTOR_IMPL_HPP_
