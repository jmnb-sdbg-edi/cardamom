...
#include "lifecycleserver1/ProcessAgent.skel.hpp"
...
typedef Cdmw::LifeCycle::NamedObjectsFactoryAllocator<ProcessAgentFactory_impl> ProcessAgentFactory_impl_Allocator;
