...
CDMW_CP=$(CDMW_HOME)/lib/java/libcdmwcommon.jar \
        ...
        $(CDMW_HOME)/lib/java/libcdmwccmcommon.jar \
        $(CDMW_HOME)/lib/java/libcdmwccmcif.jar \
        $(CDMW_HOME)/lib/java/libcdmwccmcontainer.jar \
        $(CDMW_HOME)/lib/java/libcdmwccmcomponentserver.jar \
        $(CDMW_HOME)/lib/java/libcdmwtestutils.jar \
        $(CDMW_HOME)/lib/java/libcdmwccmcontaineridl.jar \
