...
class LoggingMechanism {
    ...
    public:
        ...
        // To add a replica (It must implement the FT::Checkpointable interface)
        void add_replica(FT::Checkpointable_ptr replica);
    ...
    private:
        ...
        // List of registered replicas
        std::list<FT::Checkpointable_var> m_replicas;
