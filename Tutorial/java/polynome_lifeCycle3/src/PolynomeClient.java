...
public class PolynomeClient {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Start Polynome Client");
        ...
        try  {
            ...
            cdmw.cdmwinit.ProcessControl processCtrl =
                  new PolynomeClientProcessControl(orb);
    
    
            // ===================================================
            // Call generated cdmwinit
            // ===================================================
            cdmw.generated.PolynomeClientCdmwInterface.cdmwInit(orb, args, processCtrl);
        ...
        if (orb != null) {
            try {
                ...
                // ================================================================
                cdmw.generated.PolynomeClientCdmwInterface.cdmwCleanup(orb);
