...
class PolynomeClientProcessControl extends cdmw.cdmwinit.ProcessControl 
{
    private org.omg.CORBA.ORB orb;
    
    private String applicationName;
    private String processName;
    private PolynomeClientThread polynomeClientThread;
    
    
    public PolynomeClientProcessControl(org.omg.CORBA.ORB orb) {
        this.orb = orb;
        this.polynomeClientThread = null;
        ...
        com.thalesgroup.CdmwPlatformMngtBase.StartupKind startupKind)
    {
        try {
            ...
            // ==================================================
            polynomeClientThread = new PolynomeClientThread (orb, 
                                                             applicationName,
                                                             processName);
    ...
    public void onStop()
    {
        try {
            ...
            if (polynomeClientThread != null) {
                ...
                if (polynomeClientThread.isAlive()) {
                    polynomeClientThread.stopThread();
                    polynomeClientThread.join();
                }
                
                polynomeClientThread = null;;
            }            
