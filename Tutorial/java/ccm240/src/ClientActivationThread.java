...
class ClientActivationThread
    extends Thread
{
    
    private ClientExecutorImpl client;
    
    
    public ClientActivationThread(ClientExecutorImpl client) {
        this.client = client;
    }
    ...
    public void run() {
        try {
            ...
            // ========================================================    
            System.out.println("Connect to the display facet...");
        
            com.acme.Hello.Display display = 
                client.sessionContext.get_connection_client_receptacle();
