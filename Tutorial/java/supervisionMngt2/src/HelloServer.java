...
public class HelloServer {
    ...
    public static void main(String[] args) {
        ...
        try  {
            ...
            // ======================================================
            org.omg.PortableServer.POA CDMW_rootPOA = 
                cdmw.cdmwinit.InitUtils.createCdmwRootPOA(orb);
            
            org.omg.PortableServer.POAManager cdmwPoaManager = 
                CDMW_rootPOA.the_POAManager();
            
            // ===================================================
            // Activate the poa manager of the CDMW root POA
            // ===================================================
            ...
            // CdmwProcessImpl() will acquire a reference on ProcessControl object and
            // will automatically release it at object's destruction.
            cdmw.cdmwinit.CdmwProcessImpl processImpl = 
                new cdmw.cdmwinit.CdmwProcessImpl (orb, 
                                                      rootPOA,
                                                      CDMW_rootPOA,
                                                      processCtrl);
            ...
            com.thalesgroup.CdmwNamingAndRepository.Repository repository = 
                cdmw.cdmwinit.InitUtils.getCdmwRepository();
