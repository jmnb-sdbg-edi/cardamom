    ...
    extends cdmw.tutorial.PrinterServantProvider 
{
    ...
    private static final String PRINTER_REP_ID = com.thalesgroup.PrinterModule.ColorPrinterHelper.id();

    private static final String BW_PRINTER = "Bw_Printer_";
    private static final String COLOR_PRINTER = "Color_Printer_";
    ...
    *
    *@param  printer_oid string oid of object
    *
    *@return object id
    */
        ...
        throws org.omg.CORBA.SystemException
    {
        ...
        String object_oid = BW_PRINTER + device + "_" + oidCounter + "_" + timeval.getSeconds(); 
    ...
    /**
    * Purpose:
    * <p> This method creates the oid of the ColorPrinter object
    *
    *@param  printer_oid string oid of object
    *
    *@return object id
    */
    public byte[] create_color_printer(String device)
        throws org.omg.CORBA.SystemException
    {
        //
        // create an unique id
        ...
        String object_oid = COLOR_PRINTER + device + "_" + oidCounter + "_" + timeval.getSeconds(); 
    ...
    */    
        ...
        throws org.omg.PortableServer.ForwardRequest 
    {
        ...
        //
        ColorPrinterImpl printerImpl = new ColorPrinterImpl(objectDeactivator);
        
        String type = new String(oid);
        
        if (type.startsWith(COLOR_PRINTER)) {
            printerImpl.setColor();
        } else {
            printerImpl.setBlackAndWhite();
        }
        
        // NOTE: The servant is a TIE (see note into ColorPrinterImpl)
        org.omg.PortableServer.Servant servant = 
            new com.thalesgroup.PrinterModule.ColorPrinterPOATie(printerImpl, poa);
