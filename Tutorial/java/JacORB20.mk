...
ORB_JARS:=jacorb.jar idl.jar antlr-2.7.2.jar avalon-framework-4.1.5.jar \
          concurrent-1.3.2.jar logkit-1.2.jar wrapper-3.0.3.jar
...
JIDLFLAGS=$(JIDL_INCLUDE_DIR) $(JIDLFLAGS_ORB) \
	-i2jpackagefile $(PWD)/package.txt -d $(PWD)/prod
