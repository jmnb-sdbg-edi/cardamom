...
CPPFLAGS_CDMW=-I$(CDMW_HOME)/include/c++ \
	-I$(XERCES_INC_PATH) -I$(TAO_ROOT)/orbsvcs/orbsvcs \
...
LIBS_CDMW=-lcdmwcommon -lcdmwlogging -lcdmwcommonidl -luuid -lcdmwosthreads -lxerces-c1_3 -lcdmwossupport -lcdmworbsupport -lcdmwplatforminterface -lcdmwtestutils \
          -lcdmwccmcontaineridl -lcdmwpullmonitorableidl -lcdmwcommonsvcsnaming -lcdmwcommonsvcsdatastore \
          -lcdmwcommonsvcsfederation -lcdmwrepositoryinterface -lcdmwrepositoryidl -lcdmwlifecycle \
          -lcdmwlifecycleidl -lcdmwlifecycleinit -lcdmweventidl -lcdmweventinterface -lcdmwccmcommon \
          -lcdmwccmcif -lcdmwccmcontainer -lcdmwccmcontaineridl -lcdmwccmdeploymentidl -lcdmwccmcomponentserver \
          -lcdmwcdmwinit -lcdmwsmgcommonidl -lcdmwsmginterfaceidl -lcdmwplatformlibrary -lcdmwplatformvaluetypes \
          -lcdmwloadbalancingidl -lcdmwgroupmanageridl -lcdmwlbgroupmanager -lcdmwlbcommon -lcdmwlbstrategy \
          -lcdmwlbinit \
