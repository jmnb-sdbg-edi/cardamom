...
//
class PhilosopherHomeExecutor_impl : virtual public CCM_PhilosopherHome,
                                     virtual public Cdmw::OrbSupport::RefCountLocalObject
{
    
  public:

    PhilosopherHomeExecutor_impl();
    ~PhilosopherHomeExecutor_impl();
  ...
  private:
    ...
    PhilosopherHomeExecutor_impl(const PhilosopherHomeExecutor_impl&);
    void operator=(const PhilosopherHomeExecutor_impl&);
