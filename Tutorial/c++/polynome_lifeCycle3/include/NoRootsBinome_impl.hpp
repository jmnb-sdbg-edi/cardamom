...
#ifndef INCL_NOROOTSBINOME_IMPL_HPP
#define INCL_NOROOTSBINOME_IMPL_HPP
...
{ 
  ...
  public:
    ...
    NoRootsBinome_impl (const Cdmw::LifeCycle::ObjectDeactivator & obj_d)
  ...
  private:
    ...
    NoRootsBinome_impl(const NoRootsBinome_impl&);
    void operator=(const NoRootsBinome_impl&);
...
#endif // INCL_NOROOTSBINOME_IMPL_HPP
