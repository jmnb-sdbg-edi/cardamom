...
#ifndef INCL_TWOROOTSBINOME_HPP
#define INCL_TWOROOTSBINOME_HPP
...
{ 
  ...
  public:
    ...
    TwoRootsBinome_impl (const Cdmw::LifeCycle::ObjectDeactivator & obj_d,
                         CORBA::Double a, 
                         CORBA::Double b , 
                         CORBA::Double delta)
  ...
  private:
    ...
    TwoRootsBinome_impl(const TwoRootsBinome_impl&);
    void operator=(const TwoRootsBinome_impl&);
    
    // polynome coefficients
    CORBA::Double m_a;
    CORBA::Double m_b;
    CORBA::Double m_delta;
