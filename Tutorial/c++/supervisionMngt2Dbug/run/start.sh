...
$TERM -ls -sb -sl 500 -e $CDMW_HOME/bin/cdmw_platform_supervision --CdmwLocalisationService=21871 --creation-timeout=3600000 --event-timeout=6000 &
SUPERVISION_PID=$!
sleep $INIT_TIMEOUT
...
then
    ...
    $TERM -ls -sb -sl 500 -e $CDMW_HOME/bin/cdmw_platform_supervision --CdmwLocalisationService=21871 --FaultManagerRegistration=corbaloc::localhost:4555/fault_manager --RequestDurationTime=20000000 --creation-timeout=3600000 --creation-timeout=20000&
    SUPERVISION_PID=$!
else
    $echo Starting the Platform Management Supervision...
    $TERM -ls -sb -sl 500 -e $CDMW_HOME/bin/cdmw_platform_supervision --CdmwLocalisationService=21871 --creation-timeout=3600000 --event-timeout=6000 &
