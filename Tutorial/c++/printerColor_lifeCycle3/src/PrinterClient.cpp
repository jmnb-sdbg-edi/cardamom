...
{    
    ...
    try 
    {
        ...
        // ======================================================
        // find the ColorPrinter factory object from repository
        // ======================================================
        CdmwLifeCycle::FactoryBase_var factory = factoryFinder->find_factory (
                        "Printer.Domain/Printer.Factories/PrinterSession.factory");
                        
                        
	    PrinterFactories::ColorPrinterSessionFactory_var printer_factory = 
	             PrinterFactories::ColorPrinterSessionFactory::_narrow(factory.in());

        // ======================================================
	    // get the ColorPrinter proxy from the factory
	    // ======================================================
	    PrinterModule::ColorPrinter_var printer = 
	             PrinterModule::ColorPrinter::_nil();
	             	    
	    printer = printer_factory->create_color_printer ("lpr10");       
        ...
        // ===================================================
        // Call print_message method of ColorPrinter object
        // ===================================================
	    printer->print_message (">>>>> HELLO 2 <<<<<");
