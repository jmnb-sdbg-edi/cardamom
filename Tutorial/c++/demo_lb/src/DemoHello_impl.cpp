...
namespace Cdmw
{
    ...
    HelloInterface_impl::HelloInterface_impl(std::string location)
        ...
        :m_location(location)
    {
        m_process_info = new Cdmw::Demo::process_info();
    ...
    Cdmw::Demo::process_info* HelloInterface_impl::who_is_called()
        throw(CORBA::SystemException)
    {
        std::cout<< "*****************************************************************"<<std::endl;
        ...
        Cdmw::Demo::process_info_var process_info;
        Cdmw::Demo::process_info info;
        info.name = m_process_info->name;
        info.processID = m_process_info->processID;
        process_info = new Cdmw::Demo::process_info(info);
