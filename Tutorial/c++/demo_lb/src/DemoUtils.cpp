...
DemoUtils::create_group(CORBA::ORB_ptr orb, CdmwLB::LBGroupManager_ptr group_manager, const char * rep_id)
...
int
DemoUtils::get_object_group_version(CORBA::ORB_ptr orb, ::PortableGroup::ObjectGroup_ptr object_group)
    throw (CORBA::Exception)
{
...
int 
DemoUtils::get_number_of_member(CORBA::ORB_ptr orb, ::PortableGroup::ObjectGroup_ptr object_group)
    throw (CORBA::Exception)
{
    Cdmw::LB::IOGRFactory* m_iogrFactory;
