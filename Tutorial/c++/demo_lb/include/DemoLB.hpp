...
#ifndef INCL_DEMO_LB_HPP
#define INCL_DEMO_LB_HPP
...
namespace LB {
  ...
  class DemoLB: public Cdmw::OsSupport::Thread
  {
  public:
    // constructor
    DemoLB(CORBA::ORB_ptr                  orb,
