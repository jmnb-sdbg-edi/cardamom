...
CLIENT_NAME=printerClient2
SERVER_NAME=printerServer


# CARDAMOM Generated Code
CDMW_GEN_CLIENT_SRC=PrinterClientCdmwInterface.cpp
CDMW_GEN_SERVER_SRC=PrinterServerCdmwInterface.cpp \
                     PrinterServantProvider.cpp \
                     PrinterSessionFactory_impl.cpp
...
SERVER_SRCS=$(CDMW_GEN_SERVER_SRC) \
            PrinterUserServantProvider.cpp \
            ColorPrinter_impl.cpp \
	        PrinterServer.cpp
