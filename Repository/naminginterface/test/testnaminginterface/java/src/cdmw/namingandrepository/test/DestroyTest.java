...
public class DestroyTest extends Testable {
    ...
    public void doTests() {
        ...
        String input = base + "/namingandrepository/dummy/ada.1";
        ...
        //
        // Destroy namingandrepository/ada.1 naming context
        //
        input = base + "/namingandrepository/ada.1";
        ...
        // Forcing destroy
        input = base + "/namingandrepository/ada.2";
    ...
    private boolean installInitialBindings(NamingInterface n,String base,
        ...
        try {
            ...
            ni.bind("namingandrepository/c++/CVS/Entries",obj,true);
            ni.bind("namingandrepository/c++/CVS/Entries.Log",obj,true);
            ni.bind("namingandrepository/c++/CVS/Repository",obj,true);
            ni.bind("namingandrepository/c++/CVS/Root",obj,true);
            ni.bind("namingandrepository/c++/incl/CVS/Entries",obj,true);
            ni.bind("namingandrepository/c++/incl/CVS/Repository",obj,true);
            ni.bind("namingandrepository/c++/incl/CVS/Root",obj,true);
            ni.bind("namingandrepository/c++/incl/NameParser.hpp",obj,true);
            ni.bind("namingandrepository/c++/incl/NameParserContext.hpp",obj,true);
            ni.bind("namingandrepository/c++/incl/NameParserFSM.hpp",obj,true);
            ni.bind("namingandrepository/c++/src/CSC.mk",obj,true);
            ni.bind("namingandrepository/c++/src/CVS/Entries",obj,true);
            ni.bind("namingandrepository/c++/src/CVS/Repository",obj,true);
            ni.bind("namingandrepository/c++/src/CVS/Root",obj,true);
            ni.bind("namingandrepository/c++/src/InvalidName.cpp",obj,true);
            ni.bind("namingandrepository/c++/src/main.cpp",obj,true);
            ni.bind("namingandrepository/c++/src/NameParser.cpp",obj,true);
            ni.bind("namingandrepository/c++/src/NameParserContext.cpp",obj,true);
            ni.bind("namingandrepository/c++/src/NameParserFSM.cpp",obj,true);
            ni.bind("namingandrepository/c++/src/NamingInterface.cpp",obj,true);
            NamingInterface nitf
                = ni.bindNewContext("namingandrepository/ada.1",true);
            nitf = ni.bindNewContext("namingandrepository/ada.2",true);
        } catch (Exception e) {
