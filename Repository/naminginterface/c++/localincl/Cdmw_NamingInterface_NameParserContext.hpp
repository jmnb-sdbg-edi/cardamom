...
#ifndef INCL_NAMINGINTERFACE_NAMEPARSERCONTEXT_HPP
#define INCL_NAMINGINTERFACE_NAMEPARSERCONTEXT_HPP
...
class Cdmw_NamingInterface_NameParserContext
{
    ...
    public:
        ...
        *@exception Cdmw::NamingAndRepository::InvalidNameException Contains an error message
        */
        void FSMError(const char* t, const char* s)
        throw (Cdmw::NamingAndRepository::InvalidNameException);
        ...
        * 
        *@exception Cdmw::NamingAndRepository::InvalidNameException A trailing
        * '.' is used but this is not permitted by INS specification.
        */
        void add_last_kind() throw (Cdmw::NamingAndRepository::InvalidNameException);
        ...
        * kind fields.
        * 
        *@exception Cdmw::NamingAndRepository::InvalidNameException Invalid empty name component
        * (a '.' may be missing)
        */
        void check_id_not_empty() throw (Cdmw::NamingAndRepository::InvalidNameException);
        ...
        * 
        *@exception Cdmw::NamingAndRepository::InvalidNameException Unexpected end of
        * string. Raised when the input string ends with an escaped character is
        * missing.
        */
        void unexpected_eos() throw (Cdmw::NamingAndRepository::InvalidNameException);
...
#endif // INCL_NAMINGINTERFACE_NAMEPARSERCONTEXT_HPP
