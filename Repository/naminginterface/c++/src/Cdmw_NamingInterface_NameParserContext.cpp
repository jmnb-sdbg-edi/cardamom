...
#include "naminginterface/Cdmw_NamingInterface_NameParserContext.hpp"
...
throw (Cdmw::NamingAndRepository::InvalidNameException)
{
    ...
    CDMW_THROW1(Cdmw::NamingAndRepository::InvalidNameException, str.c_str()); // TODO: use named constants
}
...
throw (Cdmw::NamingAndRepository::InvalidNameException)
{
    ...
    if (!m_id.empty() && m_kind.empty())
        CDMW_THROW1(Cdmw::NamingAndRepository::InvalidNameException, TRAILING_DOT_NOT_ALLOWED);
...
throw (Cdmw::NamingAndRepository::InvalidNameException)
{
    CDMW_THROW1(Cdmw::NamingAndRepository::InvalidNameException, UNEXPECTED_ENDS);
}
...
throw (Cdmw::NamingAndRepository::InvalidNameException)
{
    ...
    if (m_id.empty())
        CDMW_THROW1(Cdmw::NamingAndRepository::InvalidNameException, MISSING_DOT);
}
