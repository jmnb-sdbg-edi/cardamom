...
#ifndef INCL_NAMINGANDREPOSITORY_TestRepository_HPP 
#define INCL_NAMINGANDREPOSITORY_TestRepository_HPP 
...
*
*/
class TestRepository : public TestUtils::Testable
{
    ...
    public:
        ...
        *@exception
        */ 
        TestRepository(CosNaming::NamingContext_ptr)
                throw();
        ...
        *@exception
        */ 
        TestRepository(const TestRepository& rhs)
                throw();
        ...
        */ 
        TestRepository&
        operator=(const TestRepository& rhs)
                throw();
...
#endif // INCL_NAMINGANDREPOSITORY_TestRepository_HPP 
