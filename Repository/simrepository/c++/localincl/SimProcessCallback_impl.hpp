...
#include "SystemMngt/idllib/CdmwPlatformMngtEntityObserver.stub.hpp"
...
public:
    ...
    SimProcessCallback_impl(PortableServer::POA_ptr,
                            ...
                            CdmwPlatformMngtEntity::EntityObserver_ptr,
    ...
    set_ready(CdmwPlatformMngt::Process_ptr the_process)
        throw(CORBA::SystemException);
...
private:
    ...
    CdmwPlatformMngtEntity::EntityObserver_var  m_entity_observer;
