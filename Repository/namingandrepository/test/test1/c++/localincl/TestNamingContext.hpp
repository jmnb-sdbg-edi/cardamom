...
#ifndef INCL_TESTNAMINGCONTEXT_HPP
#define INCL_TESTNAMINGCONTEXT_HPP
...
class TestNamingContext : virtual public Cdmw::TestUtils::Testable
{
...
public:
    ...
    TestNamingContext(const std::string& name,
        CORBA::ORB_ptr orb,
        CdmwNamingAndRepository::Repository_ptr repository);

    virtual ~TestNamingContext();
...
#endif // INCL_TESTNAMINGCONTEXT_HPP
