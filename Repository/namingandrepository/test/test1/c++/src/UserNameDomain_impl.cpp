          ...
          CORBA::SystemException)
{
    ...
    try
    {
        ...
        CosNaming::Name_var name = Cdmw::NamingAndRepository::NamingInterface::to_name(object_name);
          ...
          CORBA::SystemException)
{
    ...
    try
    {
        ...
        CosNaming::Name_var name = Cdmw::NamingAndRepository::NamingInterface::to_name(factory_name);
...
CdmwNamingAndRepository::NameDomain_ptr UserNameDomain_impl::resolve_name_domain(const char* domain_name)
          ...
          CORBA::SystemException)
{
    ...
    try
    {
        ...
        CosNaming::Name_var name2 = Cdmw::NamingAndRepository::NamingInterface::to_name(name);
