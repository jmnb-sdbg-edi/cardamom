...
TesterFactory_impl::TesterFactory_impl(std::string name)
    :m_name(name)
{
    ...
    throw(CORBA::SystemException)
{
    ...
    if (!strcmp(repository_id, "IDL:Cdmw/Test/Tester:1.0"))
        res = true;
    ...
    throw(CORBA::SystemException)
{
    ...
    CORBA::RepositoryId_var repId = CORBA::string_dup("IDL:Cdmw/Test/Tester:1.0");
