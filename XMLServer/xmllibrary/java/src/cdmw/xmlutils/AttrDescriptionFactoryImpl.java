...
/**
 * Implementation of the AttrDescription value factory
 *
 */
public class AttrDescriptionFactoryImpl
    implements com.thalesgroup.CdmwXML.AttrDescriptionValueFactory {
    ...
    public java.io.Serializable
        read_value(org.omg.CORBA_2_3.portable.InputStream in) {
            java.io.Serializable desc = new AttrDescriptionImpl();
            return in.read_value(desc);
    }
    
    /**
     * Creates an AttrDescription valuetype.
     *
     * @param reference Basic reference to the DOM Attr.
     * @param name Name of the attribute.
     * @param value Value of the attribute.
     * @return The new AttrDescription valuetype.
     */
    public com.thalesgroup.CdmwXML.AttrDescription create(
        com.thalesgroup.CdmwXML.Attr reference, short[] name, short[] value) {
        return new AttrDescriptionImpl(reference, name, value);
    }
