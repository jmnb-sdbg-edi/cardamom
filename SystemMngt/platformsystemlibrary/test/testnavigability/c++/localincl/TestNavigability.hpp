...
*
*/
class TestNavigability : public CppUnit::TestFixture
{
    ...
    private:
        ...
        * 
        */ 
        TestNavigability& operator=(const TestNavigability& rhs) throw();
        /**
        * Purpose:
        * <p>  Copy constructor
        * 
        */ 
        TestNavigability(const TestNavigability& rhs) throw();
        

CPPUNIT_TEST_SUITE(TestNavigability);
