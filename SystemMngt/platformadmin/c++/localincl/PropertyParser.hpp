...
class PropertyParser : public virtual ConfigElementParser
{
public:
...
class PropertyContainerParser : public virtual ConfigElementParser
{
protected:
    PropertyContainerParser( const DOM_Node& propertyContainerParser );
