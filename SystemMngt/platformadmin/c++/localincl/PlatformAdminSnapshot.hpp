...
std::string snapShotToString( CdmwPlatformMngt::HostSnapshot*, const char* );
...
std::string snapShotToString( CdmwPlatformMngt::EntitySnapshot*, const char* );
std::string snapShotToString( CdmwPlatformMngt::PropertySnapshot*, const char* );
