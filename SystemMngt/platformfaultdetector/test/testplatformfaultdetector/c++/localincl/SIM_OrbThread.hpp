...
class OrbThread : public OsSupport::Thread {
    ...
    public:
        ...
        OrbThread(){
            ...
            int argc(0);
            //int argc(2);
            std::string str_opt("-ORBDebugLevel 10");
	    ...
	    //service_activate->init(argc, NULL);

            m_orb = OrbSupport::OrbSupport::ORB_init(argc,NULL, strategyList );
            //m_orb = OrbSupport::OrbSupport::ORB_init(argc, argv__, strategyList );        
        // TO be removed walk around!!!!!
        //Cdmw::OrbSupport::OrbSupport::set_endpoint_selector_factory("FT_Endpoint_Selector_Factory");
