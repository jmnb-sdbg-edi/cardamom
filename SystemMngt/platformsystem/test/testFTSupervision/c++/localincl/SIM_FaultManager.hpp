...
public:
    // constructor
    SIM_FaultManager(CORBA::ORB_var m_orb,
     ...
     * operation
     */
    CdmwFT::FTManagerObjects* get_FTManager_objects(const char*, const CdmwFT::StateTransfer::DataStores&, const CdmwFT::LocationList&)
