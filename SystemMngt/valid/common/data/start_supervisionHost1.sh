...
echo "cdmw_platform_supervision_starter --CdmwXMLFile=CdmwPlatformMngtSystemStartHost1.xml --validate $*"
cdmw_platform_supervision_starter --CdmwXMLFile=CdmwPlatformMngtSystemStartHost1.xml --validate $*
else
