...
SIM_ServiceDefContainerAccessor_impl::SIM_ServiceDefContainerAccessor_impl()
                throw()
{
}
...
SIM_ServiceDefContainerAccessor_impl::get_service_def (
                      ...
                      CORBA::SystemException)
{
    ...
    return TestSamples::getServiceProviderID();
}

        

SIM_ServiceDefContainerAccessor_impl::SIM_ServiceDefContainerAccessor_impl (const SIM_ServiceDefContainerAccessor_impl& rhs)
                throw()
{
   CDMW_NEVER_HERE();
}
...
SIM_ServiceDefContainerAccessor_impl::operator=(const SIM_ServiceDefContainerAccessor_impl& rhs)
                throw()
{
    CDMW_NEVER_HERE();
    return *this;
