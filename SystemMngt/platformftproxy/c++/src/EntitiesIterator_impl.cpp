...
EntitiesIterator_impl::EntitiesIterator_impl(CORBA::ORB_ptr orb,
...
EntitiesIterator_impl::~EntitiesIterator_impl () throw ()
{        
...
EntitiesIterator_impl::getTarget() 
 ...
 */
CORBA::Boolean 
EntitiesIterator_impl::next_one(CdmwPlatformMngt::Entity_out entity)
    throw(CORBA::SystemException)
{
    CdmwPlatformMngt::ElementPathsIterator_var target = this->getTarget();
    ...
    if (succeed) {
	entity = m_proxy_collection->createEntityRef(element_path.ptr());
    }
 ...
 */
CORBA::Boolean 
EntitiesIterator_impl::next_n(CORBA::ULong how_many,
    ...
    throw(CORBA::SystemException)
{
    ...
    if (succeed) {
	entities = m_proxy_collection->createEntitiesFromSeq(element_paths.ptr());
    }
