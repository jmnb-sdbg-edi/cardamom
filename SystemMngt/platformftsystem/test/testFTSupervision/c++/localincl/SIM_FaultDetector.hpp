...
#ifndef INCL_SIM_FAULT_DETECTOR_HPP
#define INCL_SIM_FAULT_DETECTOR_HPP
...
class SIM_FaultDetector : virtual public POA_CdmwFT::FaultManagement::FaultDetector,
                          public virtual Cdmw::OrbSupport::RefCountServantBase
{
public:
    // constructor
    SIM_FaultDetector(CdmwFT::FaultManagement::FaultDetector_ptr fault_detector);

    // destructor
    virtual ~SIM_FaultDetector();
    ...
    /**
     * start_monitoring_is_called
     */
    bool start_monitoring_is_called();
...
#endif //INCL_TEST_FAULT_DETECTOR_HPP
