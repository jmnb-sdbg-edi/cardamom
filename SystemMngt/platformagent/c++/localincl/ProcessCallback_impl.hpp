...
#ifndef INCL_PLATFORMMNGT_PROCESSCALLBACK_IMPL_HPP 
#define INCL_PLATFORMMNGT_PROCESSCALLBACK_IMPL_HPP 
...
#include "idllib/CdmwPlatformMngtProcessDelegate.stub.hpp"
...
* interface
*/
class ProcessCallback_impl : virtual public DeactivableServant_impl,
                             virtual public POA_CdmwPlatformMngt::ProcessCallback,
...
public:
    ...
    */ 
    ProcessCallback_impl(
              ...
              const CdmwPlatformMngt::ProcessCallback::ProcessStartingData& acknowledgementData);
    ...
    */ 
    ...
    /**
    * Purpose:
    * <p> Returns the issuer of the error.
    */ 
    const char* getErrorIssuer();
...
protected:
    ...
    */
    ...
    /**
    * The issuer of the error.
    */
    std::string m_errorIssuer;
...
#endif // INCL_PLATFORMMNGT_PROCESSCALLBACK_IMPL_HPP
