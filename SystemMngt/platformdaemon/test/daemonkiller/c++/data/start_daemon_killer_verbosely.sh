...
# Cdmw Daemon program
daemon_exe=@CDMW_PLATFORM_DAEMON_PATH@/cdmw_platform_daemon_killer
...
start_daemon()
{
    ...
    # start daemon
    exec $daemon_exe --CdmwXMLFile=CdmwPlatformMngtDaemon_conf.xml $started_by_script_checking_option $arg
}
