...
#cdmw_platform_supervision --CdmwLocalisationService=21872 --creation-timeout=20000 --event-timeout=6000 --RequestDurationTime=20000 &
...
./cdmw_testuserdefinedattributes
