...
#include "testftbackupinsertion/MyProcessBehaviour.hpp"
    ...
    int main( int argc, char* argv[] )
    {
        ...
        if (server == "no") 
        {
            ...
            try
            {
                ...
                // Do test
                Cdmw::FT::TestBackupInsertion test(orb.in(), rootPOA.in(), "Testftbackupinsertion", argv[0], host_name1, host_name2, host_name3);
                test.start();
