...
public:
	...
	*/
        ...
        throw( CORBA::SystemException)
    {
        ...
        std::cout << m_name << " test_server: get_repository"<<std::endl;
        ...
        Cdmw::HelloInterface1_impl * helloInterface1_impl = new Cdmw::HelloInterface1_impl(m_orb.in(), m_rootPOA.in(), m_name.c_str());
        CdmwReplicationManager::HelloInterface1_var helloInterface1 =  helloInterface1_impl->_this();

        Cdmw::HelloInterface2_impl * helloInterface2_impl = new Cdmw::HelloInterface2_impl(m_orb.in(), m_rootPOA.in(), m_name.c_str());
        CdmwReplicationManager::HelloInterface2_var helloInterface2 =  helloInterface2_impl->_this();
        
        std::string full_name1 = process_name + "HelloInterface1";
        std::string full_name2 = process_name + "HelloInterface2";
        ...
        try
        {
            CdmwNamingAndRepository::NameDomain::RegistrationId_var regId = helloDomain->new_name (full_name1.c_str());
            // register the object
            helloDomain->register_object (regId.in() , helloInterface1.in ());
        }
        ...
        try
        {
            CdmwNamingAndRepository::NameDomain::RegistrationId_var regId = helloDomain->new_name (full_name2.c_str());
            // register the object
            helloDomain->register_object (regId.in() , helloInterface2.in ());
        }
        catch (const CORBA::SystemException& e)
        {
	...
	*/
    ...
    {    
        std::cout << " test_server: on_run called" << std::endl;
	...
	*/
    ...
    {    
        std::cout << " test_server: on_stop called" << std::endl;
