...
#ifndef INCL_PLATFORMADMIN_CONFIGELEMENTPARSER_HPP
#define INCL_PLATFORMADMIN_CONFIGELEMENTPARSER_HPP
...
public:
    ...
    : Exception( Exception::SAFE, errorMsg )
    {};
};
...
public:
    NotFoundException()
    : Exception( Exception::SAFE, "Configuration parser not found exception" )
    {};
};
...
#endif //INCL_PLATFORMADMIN_CONFIGELEMENTPARSER_HPP
