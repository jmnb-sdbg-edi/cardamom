...
@CDMW_CCMDEPLOYMENT_LIB_JAR_PATH@/lib@config.lowercase.product.name@ccmdeploymentidl.jar:\
@CDMW_CCMDEPLOYMENT_LIB_JAR_PATH@/lib@config.lowercase.product.name@ccmpackagemanager.jar:\
...
exec java -Xbootclasspath/p:$__CLASSPATH__ cdmw.ccm.deployment.PackageManager $*
