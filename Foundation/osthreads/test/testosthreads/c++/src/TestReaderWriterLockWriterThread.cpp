...
namespace Cdmw
{
    ...
    namespace OsSupport
    {
        ...
        TestReaderWriterLockWriterThread::TestReaderWriterLockWriterThread(
        ...
        void
        TestReaderWriterLockWriterThread::run()
        throw()
        {
            ...
            for ( int iCount = 0; iCount < m_nbLocks; ++iCount )
            {
                ...
                m_test.increment_writer();
                Thread::sleep(timescale*get_sleepTime());
                m_test.decrement_writer();
        ...
        unsigned
        int
        TestReaderWriterLockWriterThread::get_sleepTime()
        {
            int rand_value;
