    ...
    namespace Common
    {
        ...
        */
        ...
        namespace
        {
            ...
            const char* NARROW_FAILED = "Cannot narrow to target type!";
        }

        TypeMismatchException::TypeMismatchException()
        throw()
                : Exception(Exception::SAFE, NARROW_FAILED)
        {
            // does nothing
        }
        ...
        TypeMismatchException::TypeMismatchException(const std::string& reason)
        throw()
