...
/**
 * Traits class for valuetype
 */
#define DEFINE_VALUE_TYPE_TRAITS(T) \
namespace Cdmw { \
namespace OrbSupport { \
template<> \
...
// PCR-0049
/**
 * Traits class for the valuetypes.
 */
#define DEFINE_VALUETYPE_DATA_TRAITS(T)         \
namespace Cdmw {                                \
namespace OrbSupport {                          \
template<>                                      \
struct type_traits<T>                           \
