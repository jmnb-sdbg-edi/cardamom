...
public class CdmwInterface {
    ...
    public static void cdmwInit(org.omg.CORBA.ORB orb, String[] args,
        ProcessControl ctrl, String classname)
        ...
        try {
            Class[] parameterTypes = {
                ...
                Class.forName("cdmw.cdmwinit.ProcessControl")
            };
            java.lang.reflect.Method init
                = Class.forName(classname).getMethod("cdmwInit", parameterTypes);
            if (ctrl == null) {
                Object[] parameters
                    = { orb, args, new DefaultProcessControl() };
                init.invoke(null, parameters);
            } else {
                Object[] parameters = { orb, args, ctrl };
                init.invoke(null, parameters);
            }
     ...
     * @param orb  A reference to the ORB pseudo-object
     */
    public static void cdmwCleanup(org.omg.CORBA.ORB orb, String classname) {

        try {
            Class[] parameterTypes = {
                Class.forName("org.omg.CORBA.ORB")
            };
            java.lang.reflect.Method cleanup
                = Class.forName(classname).getMethod("cdmwCleanup", parameterTypes);
            Object[] parameters = { orb };
            cleanup.invoke(null, parameters);
        } catch(ClassNotFoundException cnfe) {
            // minor code to be defined
            throw new org.omg.CORBA.BAD_PARAM();
        } catch(NoSuchMethodException nsme) {
            // minor code to be defined
            throw new org.omg.CORBA.BAD_PARAM();
